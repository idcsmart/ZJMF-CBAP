...
<div id="content" class="host-detail hasCrumb" v-cloak>
            ...
            <template v-for="(item,index) in hostFieldList">
              ...
              <div class="config-item render">
                <t-form-item :label="el.name" v-for="(el,ind) in item.field" :key="ind">
                  ...
                  <t-button class="distribute" @click="handlerDistribute" v-if="el.key === 'manual_resource'">{{lang.distribute}}</t-button>
                </t-form-item>
  ...
  <!-- 手动资源分配 -->
  <t-dialog :header="`${lang.manual_resources}${lang.distribute}`" :visible.sync="resourceDialog" width="80%" :footer="false">
