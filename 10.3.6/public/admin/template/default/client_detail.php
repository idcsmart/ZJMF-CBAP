    ...
    <t-card :class="{ stop: data.status===0}">
      ...
      <div class="info-box">
        <t-row align="middle">
          ...
          <t-col :span="6">
            <span>{{lang.user_text3}}</span>{{data.host_num}}个
          </t-col>
        </t-row>
        <t-row align="middle">
          <t-col :span="6">
          ...
          <t-col :span="6">
            <span>{{lang.user_text5}}</span>{{data.host_active_num}}个
          </t-col>
        </t-row>
        <t-row align="middle">
          <t-col :span="6">
  ...
  <t-card class="user-info">
    ...
    <t-form :data="formData" label-align="top" layout="inline" :rules="rules" ref="userInfo">
      ...
      <t-form-item :label="lang.password" name="password">
        <t-input type="password" v-model="formData.password" :placeholder="lang.password"
