...
class LineModel extends Model{
    ...
    public function lineDelete($id){
        ...
        $productId = DataCenterModel::where('data_center_id', $line['data_center_id'])->value('product_id') ?? 0;
        ...
        try{
            ...
            // 获取线路配置
            $optionId = OptionModel::where('product_id', $productId)->whereIn('rel_type', [OptionModel::LINE_BW,OptionModel::LINE_FLOW,OptionModel::LINE_DEFENCE,OptionModel::LINE_IP])->where('rel_id', $id)->column('id');
            if(!empty($optionId)){
