...
class CloudController{
	...
	*/
     ...
     * @return  string package.memory - 内存
     * @return  string package.disk - 硬盘
     * @return  object package.optional_memory - 添加内存({"5":1},5是ID,1是数量)
     * @return  object package.optional_disk - 添加硬盘({"5":1},5是ID,1是数量)
	 */
 ...
 //        return json($result);
     ...
     * @param   int flow - 流量包
     * @param   int peak_defence - 防御峰值
     * @param   object optional_memory - 变更后的内存({"5":1},5是ID,1是数量) 套餐时必须
     * @param   object optional_disk - 变更后的硬盘({"5":1},5是ID,1是数量) 套餐时必须
     * @return  string price - 价格
     * @return  string description - 生成的订单描述
	 */
