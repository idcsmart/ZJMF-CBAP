...
function getProCycle(params) {
  return Axios.post(
    `/idcsmart_common/product/${params.product_id}/custom_cycle/${params.id}`
  );
}
function addAndUpdateProCycle(type, params) {
  if (type === "add") {
    return Axios.post(
      `/idcsmart_common/product/${params.product_id}/custom_cycle`,
      params
    );
  } else if (type === "update") {
    return Axios.put(
...
function getConfigoption(params) {
  return Axios.get(
    `/idcsmart_common/product/${params.product_id}/configoption`
  );
}
function getConfigoptionDetail(params) {
  return Axios.get(
    `/idcsmart_common/product/${params.product_id}/configoption/${params.id}`
  );
}
...
function changeConfigoption(params) {
  return Axios.put(
    `/idcsmart_common/product/${params.product_id}/configoption/${params.id}/hidden`,
    params
  );
}
...
function getConfigSubDetail(params) {
  return Axios.get(
    `/idcsmart_common/configoption/${params.product_id}/sub/${params.id}`
  );
}
function addAndUpdateConfigSub(type, params) {
  if (type === "add") {
    return Axios.post(
      `/idcsmart_common/configoption/${params.product_id}/sub`,
      params
    );
  } else if (type === "update") {
    return Axios.put(
...
function deleteConfigSub(params) {
  return Axios.delete(
    `/idcsmart_common/configoption/${params.configoption_id}/sub/${params.id}`,
    params
  );
}
...
function getChildModuleParams(params) {
  return Axios.get(
    `/idcsmart_common/product/${params.product_id}/module/${params.server_id}`
  );
}
