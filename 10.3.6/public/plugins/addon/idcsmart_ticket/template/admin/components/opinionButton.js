...
link.rel = "stylesheet";
link.type = "text/css";
link.href = "/plugins/addon/idcsmart_ticket/template/admin/css/opinionButton.css";
// 将 <link> 元素插入到 <head> 中
document.head.appendChild(link);
// css 样式依赖opinionButton.css
const opinionButton = {
    template: `
    <t-tooltip :content="lang.order_text79" theme="light">
    ...
    methods: {
        ...
        goOpinion() {
            location.href = 'http://' + location.host + '/' + location.pathname.split('/')[1] + '/' + `template.htm`
        },
    },
}
