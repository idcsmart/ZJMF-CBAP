                          ...
                          <div class="domain-one">
                            <div v-if="domainList.length !==0" v-loading="isSearching">
                              ...
                              <div class="domain-list">
                                <div class="domain-item" v-for="(item,index) in calcDomainList(domainList)" :key="index">
                                  <div class="item-left">
                        ...
                        <div class="car-money">
                          ...
                          <div class="mon-right">
                            <p class="now-price">
                              ...
                              <span class="money-text"><span style="font-size: 0.24rem;">{{totalMoneyCalc.toFixed(2)}}</span> {{commonData.currency_suffix}} </span>
                            </p>
