...
class OrderController extends AdminBaseController
{
    ...
    public function settle()
    {
        ...
        if ($result['status']==200){
            ...
            if (isset($param['custom_order_amount'])){
                $OrderModel->update([
            ...
            foreach ($orderItems as $orderItem){
                ...
                if (isset($param['custom_order_amount'])){
                    ...
                    $hostUpdate['first_payment_amount'] = $param['custom_order_amount'];
                }
                if (isset($param['custom_renew_amount'])){
