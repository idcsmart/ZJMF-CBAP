...
class OrderModel extends Model
{
    ...
    public function upgradeOrderHandle($id)
    {
        ...
        if($upgrade['type']=='product'){
            ...
            $host = HostModel::find($upgrade['host_id']);
            HostModel::update([
                'first_payment_amount' => ($host['billing_cycle']=='recurring_postpaid' || $host['billing_cycle']=='recurring_prepayment') ? $upgrade['renew_price'] : ($host['pay_type']=='onetime'?$upgrade['price']:0),//$upgrade['price'],
