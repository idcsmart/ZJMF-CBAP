(function (window, undefined) {
  ...
  window.onload = function () {
    ...
    console.log(window.lang, "window");
    ...
    const MODE_OPTIONS = [
      {
        ...
        src: "./img/assets-setting-light.svg",
      },
      {
        type: "dark",
        text: window.lang.theme_dark,
        src: "./img/assets-setting-dark.svg",
      },
    ];
    const COLOR_OPTIONS = [
      "default",
          ...
          changeLang(e) {
            ...
            if (
              ...
              localStorage.setItem(
                "country_imgUrl",
                this.langList[index].country_imgUrl
              );
