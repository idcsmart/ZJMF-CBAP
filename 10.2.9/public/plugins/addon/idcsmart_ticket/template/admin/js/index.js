  ...
  window.onload = function () {
    ...
    new Vue({
      ...
      methods: {
        ...
        goclient_detail(row) {
          location.href = 'http://' + str + `client_detail.htm?client_id=${row.client_id}`
        },
        // 工单-转发-提交
        ...
        goAddorder(row) {
          if (row) {
            location.href = 'http://' + str + `/plugin/idcsmart_ticket_internal/ticket_internal_add.htm?id=${row.id}&client_id=${row.client_id}&host_ids=${row.host_ids}`
          } else {
