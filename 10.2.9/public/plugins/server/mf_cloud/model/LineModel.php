...
class LineModel extends Model{
    ...
    public function lineCreate($param){
        ...
        $this->startTrans();
        try{
            $line = $this->create($param, ['data_center_id','name','bill_type','bw_ip_group','defence_enable','defence_ip_group','ip_enable','link_clone','create_time']);
    ...
    public function lineIndex($id){
        $line = $this
                ->field('id,name,bill_type,bw_ip_group,defence_enable,defence_ip_group,ip_enable,link_clone')
                ->find($id);
        if(empty($line)){
            return (object)[];
        }
    ...
    public function lineUpdate($param){
        ...
        $this->update($param, ['id'=>$line['id']], ['name','bw_ip_group','defence_enable','defence_ip_group','ip_enable','link_clone']);
