...
function dataCenter(id) {
    return Axios.get(`/product/${id}/common_cloud/data_center`);
}
/* 产品列表 */
function cloudList(params) {
    return Axios.get(`/common_cloud`, { params });
}
// 产品详情
...
function cloudDetail(params) {
    return Axios.get(`/common_cloud/${params.id}`, { params });
}
// cloud日志
function getLog(params) {
    return Axios.get(`/common_cloud/${params.id}/log`, { params });
}
// 快照列表
function snapshotList(params) {
    return Axios.get(`/common_cloud/${params.id}/snapshot`, { params });
}
// 创建快照
function createSnapshot(params) {
    return Axios.post(`/common_cloud/${params.id}/snapshot`, params);
}
// 快照还原
function restoreSnapshot(params) {
    return Axios.post(`/common_cloud/${params.id}/snapshot/restore`, params);
}

// 获取快照/备份数量升降级价格
function backupConfig(params) {
    return Axios.get(`/common_cloud/${params.id}/backup_config`, { params });
}

// 生成快照/备份数量升降级订单
function backupOrder(params) {
    return Axios.post(`/common_cloud/${params.id}/backup_config/order`, params);
}

// 删除快照
function delSnapshot(params) {
    return Axios.delete(`/common_cloud/${params.id}/snapshot/${params.snapshot_id}`, params);
}
// 备份列表
function backupList(params) {
    return Axios.get(`/common_cloud/${params.id}/backup`, { params });
}
// 创建备份
function createBackup(params) {
    return Axios.post(`/common_cloud/${params.id}/backup`, params);
}
// 备份还原
function restoreBackup(params) {
    return Axios.post(`/common_cloud/${params.id}/backup/restore`, params);
}
// 删除备份
function delBackup(params) {
    return Axios.delete(`/common_cloud/${params.id}/backup/${params.backup_id}`, params);
}


// 获取实例磁盘
function getDiskList(params) {
    return Axios.get(`/common_cloud/${params.id}/disk`, { params });
}
// 获取其它设置
...
function diskPrice(params) {
    return Axios.get(`/common_cloud/${params.id}/disk/price`, { params });
}

// 生成购买磁盘订单
function diskOrder(params) {
    return Axios.post(`/common_cloud/${params.id}/disk/order`, params);
}

// 获取扩容磁盘价格
function expanPrice(params) {
    return Axios.post(`/common_cloud/${params.id}/disk/resize`, params);
}
// 生成磁盘扩容订单
function diskExpanOrder(params) {
    return Axios.post(`/common_cloud/${params.id}/disk/resize/order`, params);
}
...
function reinstall(params) {
    return Axios.post(`/common_cloud/${params.id}/reinstall`, params)
}
// 获取实例状态
function cloudStatus(params) {
    return Axios.get(`/common_cloud/${params.id}/status`, { params })
}
// 开机
function powerOn(params) {
    return Axios.post(`/common_cloud/${params.id}/on`, params)
}
// 关机
function powerOff(params) {
    return Axios.post(`/common_cloud/${params.id}/off`, params)
}
// 获取控制台地址
function vncUrl(params) {
    return Axios.post(`/common_cloud/${params.id}/vnc`, params)
}
// 救援模式
function rescue(params) {
    return Axios.post(`/common_cloud/${params.id}/rescue`, params)
}
// 退出救援模式
function exitRescue(params) {
    return Axios.post(`/common_cloud/${params.id}/rescue/exit`, params)
}
// 获取升降级订购页套餐
...
function upgradePackagePrice(params) {
    return Axios.get(`/common_cloud/${params.id}/package/upgrade`, { params })
}
// 生成升降级套餐订单
function upgradeOrder(params) {
    return Axios.post(`/common_cloud/${params.id}/package/upgrade/order`, params)
}
// 获取是否救援系统
function remoteInfo(params) {
    return Axios.get(`/common_cloud/${params.id}/remote_info`, { params })
}
// 重启
function reboot(params) {
    return Axios.post(`/common_cloud/${params.id}/reboot`, params)
}
// 强制重启
function hardReboot(params) {
    return Axios.post(`/common_cloud/${params.id}/hard_reboot`, params)
}
// 强制关机
function hardOff(params) {
    return Axios.post(`/common_cloud/${params.id}/hard_off`, params)
}
// 重置密码
function resetPassword(params) {
    return Axios.post(`/common_cloud/${params.id}/reset_password`, params)
}
...
function ipList(params) {
    return Axios.get(`/common_cloud/${params.id}/ip`, { params })
}
