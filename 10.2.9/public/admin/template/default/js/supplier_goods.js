        ...
        new Vue({
            data() {
                return {
                    ...
                    productRules: {
                        supplier_id: [{ required: true, message: lang.select + '所属供应商', type: 'error' }],
                        upstream_product_id: [{ required: true, message: lang.select + '商品', type: 'error' }],
                        name: [{ required: true, message: lang.input + '商品', type: 'error' }],
                        profit_percent: [{ required: true, message: lang.input + '商品', type: 'error' }],
                        certification_method: [{ required: true, message: lang.select + lang.first_group, type: 'error' }],
