    ...
    new Vue({
      ...
      data() {
        return {
          ...
          mailRules: {
            rec_person: [{ required: true, message: '请输入收件人姓名', trigger: 'blur' }],
            rec_address: [{ required: true, message: '请输入收件人地址', trigger: 'blur' }],
            rec_phone: [{ required: true, message: '请输入收件人电话', trigger: 'blur' }],
          },
          infoRules: {
