 ...
 * @title DCIM(自定义配置)-周期
 * @desc DCIM(自定义配置)-周期
 * @use server\mf_dcim\controller\admin\DurationController
 */
class DurationController{
	 ...
	 * @title 修改周期
	 * @desc 修改周期
	 * @url /admin/v1/mf_dcim/duration/:id
	 * @method  PUT
	 * @author hh
	 * @version v1
	 ...
	 * @title 获取周期比例
	 * @desc 获取周期比例
	 * @url /admin/v1/mf_dcim/duration_ratio
	 * @method  GET
	 * @author hh
	 * @version v1
	 * @param   int product_id - 商品ID require
	 ...
	 * @title 周期比例填充
	 * @desc 周期比例填充
	 * @url /admin/v1/mf_dcim/duration_ratio/fill
	 * @method  POST
	 * @author hh
	 * @version v1
     * @param   int product_id - 商品ID require
