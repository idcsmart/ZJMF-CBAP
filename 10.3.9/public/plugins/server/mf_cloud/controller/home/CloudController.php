...
class CloudController{
	 ...
	 * @version v1
	 * @param   int id - 商品ID require
	 * @param   int recommend_config_id - 套餐ID(有套餐时,套餐中参数优先)
	...
	*/
     ...
     * @return  string type - 类型(host=KVM加强版,lightHost=轻量版,hyperv=Hyper-V)
     * @return  int data_center.id - 数据中心ID
     * @return  string data_center.city - 城市
     * @return  string data_center.area - 区域
     ...
     * @return  int nat_acl_limit - 转发数量
     * @return  int nat_web_limit - 建站数量
     * @return  int config.reinstall_sms_verify - 重装短信验证(0=不启用,1=启用)
     * @return  int config.reset_password_sms_verify - 重置密码短信验证(0=不启用,1=启用)
     * @return  object recommend_config - 当前套餐配置({}=不是套餐)
     * @return  int recommend_config.bw - 带宽
     * @return  int recommend_config.cpu - 带宽
     * @return  int recommend_config.data_disk_size - 数据盘
     * @return  string recommend_config.data_disk_type - 数据盘类型
     * @return  string recommend_config.description - 描述
     * @return  int recommend_config.flow - 流量
     * @return  int recommend_config.id - 套餐ID
     * @return  int recommend_config.ip_num - IP数量
     * @return  int recommend_config.memory - 内存(GB)
     * @return  string recommend_config.name - 名称
     * @return  int recommend_config.peak_defence - 防护
     * @return  int recommend_config.system_disk_size - 系统盘
     * @return  string recommend_config.system_disk_type - 系统盘类型
     * @return  string gpu - GPU数量(''=没有GPU)
	 */
	 ...
	 * @return  int list[].is_free - 是否是免费盘(0=不是,1=是,免费盘不能升降级)
	 */
	 ...
	 * @return  int gpu[].value - GPU数量
	 * @return  string gpu_name - GPU型号
	 */
