...
Route::group('console/v1',function (){
    ...
    // Route::get('product/:id/remf_dcim/config_limit', "\\reserver\\mf_dcim\\controller\\home\\CloudController@getAllConfigLimit");
    Route::get('product/:id/remf_dcim/line/:line_id', "\\reserver\\mf_dcim\\controller\\home\\CloudController@lineConfig");
    Route::get('product/:id/remf_dcim/package', "\\reserver\\mf_dcim\\controller\\home\\CloudController@packageIndex");
...
Route::group('console/v1',function (){
	...
	Route::get('remf_dcim/:id/ip_num', "\\reserver\\mf_dcim\\controller\\home\\CloudController@calIpNumPrice");
	Route::post('remf_dcim/:id/ip_num/order', "\\reserver\\mf_dcim\\controller\\home\\CloudController@createIpNumOrder");
