const lang_obj = {
  ...
  inventory: "inventory",
  start_price: "The starting price of the item",
  start_price_tip:
    "Do not enter, the price will be calculated automatically according to the configuration",
  ...
  upgrade_price:
    "Amount of upgrade and downgrade orders, the difference between the previous two",
  ...
  clientarea_url_tip:
    "If you need to use different domain names between the background and the member center, please configure multiple domain names in the pagoda site first and fill in the address of the member center here",
  clientarea_url_tip1:
    "Member center address and website domain address cannot be the same",
  ...
  client_start_id: "User registration start ID",
  order_start_id: "User order start ID",
  random_start: "random digit start",
  appoint_num: "Specify a number",
  default_4_digits: "Default 4 digits",
  default_5_digits: "Default 5 digits",
  start_id_tip:
    "After the change, if the start ID is less than the existing data, continue to add from the existing data, if it is greater, start recording from the new start ID.",
  system_setting: "System Settings",
  system_default_setting: "System default settings",
  login_setting: "Login settings",
  debug_setting: "Debug debugging",
  debug_setting_tip:
    "It is used by system suppliers to check software problems. After enabling it, please send the following code to the software supplier, and they will obtain the administrator background login permission",
  ...
  app_scene_tip1: "Official website, website, App, store link, public account or small program name",
  app_scene_tip2: "Applications that are not online or domain names that have not been filed can apply for verification codes or notification templates to test or learn source associated signatures, but there will be restrictions on sending",
  scene_des: "Scene Description",
  scene_des_tip1: "Template usage scenarios, examples and other descriptions, login verification code scenarios can provide login links, test accounts",
  ...
  plugin_search: "Please enter application name/developer",
  hook_tip:
    "Default to the installation order, drag to adjust the serial number, serial number first",
  hook_tip1:
    "This feature is exclusive to enterprise/Professional users, free use of the official app",
  ...
  order_text78:
    "Pending order, awaiting reply, replied, and closed are the default status and cannot be modified",
  ...
  order_text88: "Modify the renewal amount for a single product",
  order_text89: "Modify the renewal amount for a single product",
  ...
  resend: "Resend",
  al_tip:
    "The account frozen amount cannot be greater than the account unfrozen amount",
  ...
  pay_tip:
    "Note: After confirmation, transaction flow will be automatically increased in the background",
  pay_tip1:
    "If you choose manual, the withdrawal application needs to be reviewed",
  pay_tip2:
    "Select automatic, and the withdrawal application will automatically pass",
  ...
  description_tip:
    "Supports html input, used to display description when ordering",
  ...
  cloud_tip:
    "Please go to data center management to add a data center and create a package",
  cloud_tip1:
    "After clicking, the price of subsequent periods will be automatically calculated and overwritten based on the monthly price",
  cloud_tip2:
    "If you want to display the data center on the order page, please go to the data center configuration page to create a data center",
  cloud_tip3:
    "You have created a data center but have not selected a data center. This package will not be displayed on the order page",
  cloud_tip4:
    "After clicking, the price of subsequent periods will be automatically calculated and overwritten based on the price of the first period",
  ...
  real_tip3:
    "If turned on, you need to upload pictures when submitting information",
  real_tip4:
  ...
  com_tip1:
    "After turning it on, you can add or subtract the quantity of goods purchased when placing an order. The minimum is 1, and the price is a multiple of the quantity.",
  com_tip2:
  ...
  com_tip3:
    "Can be left blank, used for real parameter values passed to the backend interface during automation",
  ...
  com_tip7:
    "Support html input and display description under configuration items",
  com_tip8: "Set this option as a sub-product",
  com_tip9: "Please select the sub-product fee type",
  config_tip:
    "After adding, different prices can be charged according to different configurations. If not configured, only the basic fee will be charged.",
  custom_tip:
    "Used to enter information from ordering customers and collect it, it has nothing to do with fees",
  delete_tip:
  ...
  levelevl_tip:
    "When the discount is 5%, a 9.5% discount will be displayed when the user purchases",
  ...
  invoice_tips1:
    "Only jpg/png format files can be uploaded. The file cannot exceed 5Mb",
  invoice_tips2: "Please check the headers that need to be deleted!",
  invoice_tips3:
    "If turned on, the background will receive new invoice applications",
  invoice_tips4:
    "If closed, the background will no longer receive new invoice applications",
  ...
  invoice_tips7:
    "Tax amount: collect the customer's invoice tax, 0% is tax included by default",
  ...
  invoice_btn6: "New",
  invoice_btn7: "Red",
  invoice_btn8: "flushed red",
  invoice_btn9: "Invoice item",
  invoice_btn10: "Invoice Format",
  invoice_btn11: "Are you sure to red this invoice?" ,
  invoice_btn12: "New Year's Eve issue",
  invoice_btn13: "If enabled, the user will be able to invoice for previous years",
  invoice_btn14: "If turned off, the user will not be able to invoice for previous years",
  invoice_btn15: "General Tariff Rate",
  invoice_btn16: "Invoice_BTN16",
  invoice_btn17: "Special ticket rate",
  invoice_btn18: "Special ticket tax amount",
  invoice_btn19: "View invoice",
  invoice_btn20: "Request for invoicing",
  invoice_btn21: "Invoicing order",
  invoice_btn22: "Invoicing title",
  invoice_btn23: "Invoice Style",
  invoice_btn24: "Re-upload",
  invoice_btn25: "No downloadable file",
  ...
  promo_tip1:
    "After checked, this promo code can be used in upgrade and downgrade orders",
  promo_tip2:
  ...
  promo_tip5:
    "Users can only use it by selecting the set period when purchasing",
  promo_tip6: "Discount ratio is less than or equal to 100",
  promo_tip7:
    "When no product is selected, this promo code will be available for all products by default",
  promo_tip8:
  ...
  recommend_tip2:
    "If the amount that can be withdrawn does not reach the minimum amount, you cannot withdraw it",
  recommend_tip3:
  ...
  recommend_tip5:
    "Enter the link to the member center page you want to recommend, one line per address.",
  recommend_tip6: "Please select the product first and save it",
  recommend_tip7: "Enter 0 as no withdrawal fee",

  recommend_tip8:
    "Please enter the default page for the user referral link to jump to, otherwise it will default to the system official website",
  recommend_tip9:
    "Please ensure that the link filled in is under the same domain name as the business system; After modifying the default redirect link, all user referral links will change. Please remind users of link changes in a timely manner.",
  default_recommend: "Default referral link",
  recommend_text1: "Key recommendations",
  recommend_text2: "Newly added main recommended products",
  recommend_text3: "Please select the main recommended product",
  recommend_text4:
    "There is no user ID information in this link and users need to add it themselves.",
  ...
  sale_text125:
    "The automatic confirmation period of sales commission, unconfirmed commission is not calculated in sales statistics",
  ...
  client_care_label50: "Have a specific product",
  ...
  client_care_message4:
    "Please enter the email title or select an email template",
  ...
  client_custom_label2:
    "Please customize the information that can be entered in the user details here",
  ...
  voucher_tip1:
    "Private: can only be obtained through backend management issuance",
  ...
  voucher_tip4:
    "After checked, the voucher can be used in upgrade or downgrade orders",
  ...
  voucher_tip9:
    "If the number of vouchers is insufficient, they will be issued to system users in sequence while supplies last",
  ...
  app_tip1:
    "If you do not enter it, the application will be uploaded without a deposit.",
  ...
  j_tip2:
    "If the business fails to submit new follow-up record clues after the set number of days, it will return to the high seas",
  j_tip3: "This user can see all orders",
  j_tip4:
    "The business will receive a text message notification when it receives new leads",
  j_tip5:
    "Whether to notify when a clue is automatically or manually withdrawn",
  j_tip6:
    "Leads that have not been followed up for more than x days will be notified to be followed up as soon as possible",
  ...
  j_tip9:
    "After giving up, the customer will return to the high seas and can be assigned to other business follow-up",
  j_tip10:
    "After reassignment, leads will be followed up by the newly assigned business",
  j_tip11:
    "15 days before the periodic renewal expires, a text message will be sent to remind you that the renewal is imminent",
  ...
  box_message5:
    "Please add at least one piece of expected delivery time data for small box boxes",
  box_message6:
    "Please add at least one piece of expected delivery time data for medium-sized housing boxes",
  box_message7:
    "Please add at least one piece of expected delivery time data for large box boxes",
  box_message8:
    "The promotion date end time should be greater than the start time",
  ...
  mf_area_tip:
    "If there is no configured price in a certain area. Then the foreground will not display the corresponding area",
  mf_disk_tip:
    "Please note whether the associated region is the same region. Cross region will result in disk association failure",
  mf_concat: "Associated Product Area",
  mf_concat_tip:
    "Please ensure that the Rubik's Cube Cloud configuration ID of the associated product belongs to the same region as the IP configuration ID",
  cycle_price: "Cycle price",
  cycle_ratio: "Cycle ratio",
  mf_ratio: "Ratio",
  autofill: "Autofill",
  mf_ratio_tip1:
    "Please set the cycle ratio according to the business scenario",
  mf_ratio_tip2:
    "For example, set the cycle 'month' to 1 and the cycle 'year' to 10. The price ratio of all cycles' months' to 'years' in the product configuration item is 1:10",
  mf_ratio_tip3:
    "After filling in the price for a certain period in the configuration, the prices for other periods will be automatically filled in proportionally",
  mf_ratio_tip4:
    "If the renewal period is changed, the price of the new cycle will be automatically converted according to the cycle ratio",
  ...
  default_nat_acl_tip:
    "If this parameter is selected, NAT forwarding will be selected by default and cannot be canceled when ordering.",
  default_nat_web: "Default NAT site creation",
  default_nat_web_tip:
    "After this is selected, the NAT construction site will be selected by default when the user orders and cannot be cancelled",
  mf_package_tip1: "After activation, users can only order configured packages",
  mf_package_tip2:
    "Note: The package price and configuration item price are independent, and the advanced configuration of the configuration item still takes effect",
  mf_package_tip3:
    "1. Calculation, storage, and network configuration can be configured with various parameters at will",
  mf_package_tip4:
    "2. If the 2-core CPU limit in the calculation configuration is 90, the 2-core CPU limit in the package is also 90. Same for other configurations",
  mf_package_tip5:
    "The promotion and demotion range is only limited to the same data center",
  mf_package_tip6:
    "Please ensure that the system disk capacity in the upgrade and downgrade packages is consistent",
  mf_package_tip7: "The capacity of the data disk cannot be downgraded",
  mf_package_tip8: "Do not lift when ordering page prompts",
  mf_package_tip9:
    "Please ensure that the system disk capacity/number of Gpus in the upgrade/downgrade package is consistent",
  ...
  mf_tip6:
    "1. There are multiple configuration methods for bw, and the configuration method of existing data cannot be switched to another",
  mf_tip7:
  ...
  mf_tip37:
    "The maximum number of elastic IPs that can be allocated to cloud products",
  mf_tip38: "Single GB price",
  mf_tip39:
    "The price coefficient is used to simultaneously discount the prices of all configurations for this cycle (including cycle prices)",
  mf_tip40: "Is the order displayed",
  mf_tip41:
    "Deleting the package may cause issues with renewal and promotion for users who have already purchased the current package. Please confirm if you want to delete it",
  mf_tip42:
    "1, the disk has multiple configuration modes, and the configuration mode of data cannot be switched to other",
  /* mf_dcim */
  ...
  public_ip_config: "Public IP address price configuration",
  server_model: "Server model",
  apply_discount: "Whether to apply grade discount",
  ...
  mf_p2: "Example: 64 cores 128 threads (2.7 GHZ)",
  mf_p3: "Example: 256GB DDR3-ECC",
  mf_p4: "Example: 250GB SSD",
  mf_p5:
    "The commodity will not be opened through the interface after opening the commodity, the administrator needs to manually allocate resources",
  mf_p6:
    "Please add a model specification here that allows customers to change the configuration",
  mf_p7: "Do not fill in or fill in 0 as unlimited",
  mf_p8:
    "The price here is the recommended configuration price, including bandwidth and IP",
  mf_p9:
    "The price of the optional content is calculated according to the hardware price in the hardware configuration",
  mf_p10:
    "The user starts charging for bandwidth increase from the configured bandwidth (30M is recommended, and the user will be charged 70M for upgrading to 100M)",
  mf_p11:
    "Recommended and optional configurations of memory and hard disk combined must not exceed the set maximum value",
  mf_p12: "Multiple IP addresses separated by semicolons",
  mf_p13: "Open as application",
  mf_p14: "Whether the optional machine is automatically turned on",
  mf_p15:
    "If it is turned on, the machine with the optional hardware ordered by the user will also be turned on automatically",
  mf_p16:
    "The price here does not include the option, the option content price is calculated according to the hardware price in the hardware configuration",
  mf_p17:
    "The total of optional memory and hard disk cannot exceed the set maximum value",
  mf_p18: "Value-added Option",
  mf_p19: "Added-value option",
  mf_p20:
    "After opening, the user can perform value-added selection at the front desk",
  mf_p21: "Do not fill in or fill in 0 is deemed to be disabled",
  mf_p22: "Please enter or drop-down select",
  mf_p23: "Can increase the number of items",
  mf_p24: "Optional Parameters",
  mf_p25: "Can increase disk number",
  mf_p26: "Remaining capacity",
  mf_p27:
    "When enabling the value-added option, go to ' Hardware Configuration ' to set the corresponding option parameters",
  mf_p28:
    "The remaining memory capacity is an optional value, equal to the maximum memory capacity supported by the model minus the default value on the left",
  mf_p29: "Increment is only used for promotion and demotion",
  mf_p30:
    "After opening, the user can only select value-added items in the promotion and degradation",
  ...
  income_tip1:
    "This report also displays data for the past three years, breaking down income by month.",
  ...
  income_tip6:
    "This report displays the income of all products in the current month by product grouping",
  income_tip7:
  ...
  contract_tip1:
    "Numbers within 20 digits will be automatically incremented by the system",
  contract_tip2: "Only upload one piece",
  contract_tip3: "Please enter the correct postal code",
  contract_tip4:
    "After the product is launched, the contract signing must be completed within the set time limit",
  ...
  credit_tip3:
    '*If you need multiple reminders, please use", " to enter the number of days in intervals',
  ...
  credit_tip8:
    "After days, the system will suspend products purchased with credit.",
  ...
  sub_account_text27: "For display at user ticket column table",
  ...
  single_product_text7:
    "Confirm to delete the real-name restriction of this product?",
  ...
  single_product_text20:
    "Confirm to delete the periodic restriction of this product?",
  ...
  single_product_text26:
    "Modifying the cycle will affect the cycle being restricted",
  ...
  single_product_text30:
    "Confirm to delete the quantity limit of this product?",
  ...
  room_car_text28:
    "Please select whether this is an exclusive event for car owners",
  ...
  stock_text43:
    "After the warning stock is reached, personnel will be notified via text message",
  ...
  stock_text50:
    "Please select the early warning text message to notify people!",
  ...
  cycle_tip1:
    "After changing the generation cycle, calculation will start from the date of the last order generated",
  ...
  domain_tip1:
    "Set the default search domain name when users search for domain names",
  domain_tip2:
    "Set additional domain names to be searched in addition to the default or user-selected domain names",
  domain_tip3:
    "Set the upper limit for the number of domain names to be retrieved in batches",
  domain_tip4:
  ...
  abnormal_text2:
    "Record the abnormal situations discovered during the inspection here",
  ...
  email_notice_tip:
    "Set the email notifications that the administrator needs to receive here",
  ...
  force_tip2:
    "Forced shutdown may cause data loss or file system damage. You can also actively shut down before proceeding",

  /* Multilingual products */
  product_multili: "Product Multilingual",
  multili_mark: "Multilingual identification",
  support_multili_mark: "Support multiple language fields",
  multili_tip1:
    "In the field where multiple languages are required, fill in the multilanguage identifier. The system will display the corresponding text according to the selected language",
  multili_tip2:
    "The supported fields will be displayed (support multi-language fields) prompt, if the multilanguage identifier is not filled in, the system will directly display the content of the filled in",
  multili_tip3: "Are you sure to delete this multilingual identifier?",

  /* DA */
  da_host: "host",
  da_domain: "Give away domain names",
  da_max_value: "Give the maximum value of the domain name",
  da_domain_suffix: "Gift domain name suffix",
  da_host_config: "Host configuration",
  da_host_name: "Host name",
  da_host_address: "Host address",
  belong_host: "owning host",
  da_area: "Owning area",
  independent_ip: "independent IP",
  choose_package: "Choose a package",
  disk_email: "Disk and mailbox",
  disk_space: "Disk space",
  email_num: "Email account number",
  domain_num: "Number of domain names",
  sub_domain_num: "Number of subdomain names",
  sub_domain: "second-level domain name",
  da_tip1: "Complimentary domain name for the first year",
  da_tip2:
    "If the user buys one year fee amount = domain name amount minus gift amount",
  da_tip3:
    "If purchased for many years, charge amount = domain name amount minus domain name purchase amount for one year",
  da_tip4: "Can be set at the gift domain name, gift domain name price limit",
  da_tip5:
    "Select the domain name automatically assigned when the user is opened",
  da_tip6: "Default is 1,0 is unrestricted",
  da_tip7: "Please configure the host first",
  da_tip8:
    "Information modification here only changes the front desk display, the actual change please go to DA control, change the package information will change other parameter information",

  /* 宝塔 */
  pagoda: "Pagoda",
  enterprise_edition: "Enterprise Edition",
  manage_area: "Manage Area",
  specify_host: "Specify host",
  associate_host: "Associated Host",
  web_space: "Web space",
  database_space: "Database space",
  not_specify: "Not specified",
  capacity_allocation: "Capacity Configuration",
  bt_tip1:
    "Requires XFS file system and includes prjquota mount parameter to use",
  bt_tip2:
    "The pagoda does not support setting traffic limits for the time being, 8.0.4 will be supported (currently it is only used for foreground display)",
  bt_tip3:
    "If no host is specified, the user will be automatically assigned to one of the associated hosts when purchasing",
  bt_tip4: "Periodic scaling",
  bt_tip5:
    "After opening, the price of other renewal cycles of the product will be directly converted according to the ratio of the current renewal cycle to the other cycles",

  /* 产品转移插件 */
  host_transfer_text1: "Product Transfer Plugin",
  host_transfer_text2:
    "The product transfer record is displayed here. If you need to transfer the product, please go to the user details - product information page to perform the product transfer operation.",
  ...
  host_transfer_text16:
    "Please note that this product is already associated with other products, and migration will automatically migrate all associated products together.",
  ...
  event_promotion_text1: "Event Promotion",
  event_promotion_text2: "Please enter event name/remarks",
  event_promotion_text3: "New event",
  event_promotion_text4: "Event name",
  event_promotion_text5: "Activity time",
  event_promotion_text6: "Activity scope",
  event_promotion_text7: "Activity status",
  event_promotion_text8: "Remarks",
  event_promotion_text9: "All users",
  event_promotion_text10: "Specified user",
  event_promotion_text11: "Disabled",
  event_promotion_text12: "Activating",
  event_promotion_text13: "Expired",
  event_promotion_text14: "To be effective",
  event_promotion_text15: "Activity type",
  event_promotion_text16: "Percentage",
  event_promotion_text17: "Full reduction",
  event_promotion_text18: "Fixed amount",
  event_promotion_text19: "Discount ratio",
  event_promotion_text20: "Full discount amount",
  event_promotion_text21: "Amount achieved",
  event_promotion_text22: "Promotion amount",
  event_promotion_text23: "Participating products",
  event_promotion_text24: "Applicable users",
  event_promotion_text25: "Do not select all users by default",
  event_promotion_text26: "New registered user",
  event_promotion_text27: "Only applicable to newly registered users",
  event_promotion_text28: "Existing users",
  event_promotion_text29:
    "Only applicable to existing customers (must have a verified order)",
  event_promotion_text30: "Once per user",
  event_promotion_text31:
    "A single user can only participate in this event once",
  event_promotion_text32: "Period limit",
  event_promotion_text33:
    "The user can only use the set period when purchasing",
  event_promotion_text34: "Please enter the event name",
  event_promotion_text35: "Please select the event type",
  event_promotion_text36: "Please enter the discount ratio",
  event_promotion_text37: "Please enter the full discount amount",
  event_promotion_text38: "Please select the effective time",
  event_promotion_text39: "Please select the deadline",
  event_promotion_text40: "Select event product",
  event_promotion_text41: "New event",
  event_promotion_text42: "Event details",
  event_promotion_text43: "Amount must be greater than 0",

  /* ping_test */
  ping_test: "PING test",
  ping_test_tip:
    "Set the location and IP address of the equipment room where the PING test can be initiated",
  script_download: "Script Download",
  script_download_tip:
    "The machine to use the script must be X86 and have systemd installed",
  script_execution_address: "Script execution address",
  ping_tip1: "IP address of the test area",
  ping_tip2: "The address from which the PING test script was initiated",
  ping_tip3: "Format error",

  /* Allocate the DCIM server */
  distribute_server: "Distribution server",
  dcim_tag: "tag",
  dcim_expire: "expire",
  dcim_fault: "Fault",
  preassemble: "Preassemble",
  sure_allot_server: "Are you sure to assign this server ?",
