const lang_obj = {
  ...
  cur_cycle_tip:
    "若產品續費切換週期，不使用周期比例進行價格換算,則係統將以切換週期的原價進行計算,切換週期的原價由當前週期原價按比例計算的來,因此當續費不使用周期比例時 ，修改原價將對新周期的續費價格產生影響",
  financial: "財務",
  auto_order: "工單",
  ...
  client_start_id: "用戶註冊開始ID",
  order_start_id: "用戶訂單開始ID",
  random_start: "隨機位數開始",
  appoint_num: "指定數字",
  default_4_digits: "默認4位數",
  default_5_digits: "默認5位數",
  start_id_tip:
    "更改後若開始ID小於已經存在的數據則繼續從現有新增，若大於則從新的開始ID開始記錄。",
  ...
  app_scene_tip2: "未上線應用或未備案域名，可申請測試或學習來源關聯簽名的驗證碼或通知模板，但發送會有限制",
  scene_des: "場景說明",
  scene_des_tip1: "模板使用場景、示例等說明，登錄驗證碼場景可提供登錄鏈接、測式賬號",
  upstream_info: "上游訊息",
  ...
  invoice_btn9: "發票項目",
  invoice_btn10: "發票格式",
  invoice_btn11: "確定沖紅該發票？",
  invoice_btn12: "跨年開具",
  invoice_btn13: "若開啟，用戶將可以開具之前年份的發票",
  invoice_btn14: "若關閉，用戶將不可以開具之前年份的發票",
  invoice_btn15: "普票稅率",
  invoice_btn16: "普票收稅金額",
  invoice_btn17: "專票稅率",
  invoice_btn18: "專票收稅金額",
  invoice_btn19: "查看發票",
  invoice_btn20: "申請開票",
  invoice_btn21: "開票訂單",
  invoice_btn22: "開票擡頭",
  ...
  recommend_tip8: "請輸入用戶推介連結默認跳轉的頁面，不輸入則默認系統官網",
  recommend_tip9:
    "请确保填入的链接是与业务系统在同一域名下；修改默认跳转链接后，所有用户的推介链接都会变动，请及时提醒用户链接变动。",
  default_recommend: "默認推介連結",
  recommend_text1: "主打推介",
  recommend_text2: "新增主打推介產品",
  recommend_text3: "請選擇主打推介產品",
  recommend_text4: "此處連結無用戶ID資訊需用戶自行添加",
  ...
  mf_tip42: "1、磁盤存在多種配置方式，無法將存在數據的配置方式切換到其他",
  /* mf_dcim */
  model_config: "型號配置",
  model_specs: "機型規格",
  mf_cpu: "處理器",
  ...
  mf_p16: "此處價格不包含選配，選配內容價格按照硬件配置中硬件價格計算",
  ...
  mf_p25: "可增加盤位數",
  mf_p26: "剩余容量",
  mf_p27: "啟用增值選配時，需先至“硬件配置”設置相應選配參數",
  mf_p28: "內存剩余容量為選填值，等於該機型最高支持內存容量減去左側默認值",
  mf_p29: "增值僅用於升降級",
  ...
  /* 商品多語言 */
  product_multili: "商品多語言",
  multili_mark: "多語言標識",
  support_multili_mark: "支持多語言字段",
  multili_tip1:
    "在需要用到多語言的字段處，填寫多語言標識。系統將根據選擇的語言展示對應文字",
  multili_tip2:
    "支持的字段將顯示（支持多語言字段）提示，若填寫的不是多語言標識，系統將直接按填寫內容展示",
  multili_tip3: "確定刪除該多語言標識？",

  /* DA */
  da_host: "主機",
  da_domain: "贈送域名",
  da_max_value: "贈送域名最大價值",
  da_domain_suffix: "贈送域名後綴",
  da_host_config: "主機配置",
  da_host_name: "主機名稱",
  da_host_address: "主機地址",
  belong_host: "所屬主機",
  da_area: "所屬地域",
  independent_ip: "獨立IP",
  choose_package: "選擇套餐",
  ...
  email_num: "郵箱賬號數",
  domain_num: "域名數量",
  sub_domain_num: "子域名數量",
  sub_domain: "二級域名",
  da_tip1: "贈送域名免費第壹年",
  da_tip2: "若用戶購買壹年 收費金額=域名金額減去贈送金額",
  da_tip3: "若購買多年，收費金額=域名金額減去 域名購買壹年的金額",
  da_tip4: "可在贈送域名處進行設置，贈送域名的價格限制",
  da_tip5: "選擇用戶開通時，自動分配的域名",
  da_tip6: "默認為1，0為不限制",
  da_tip7: "請先配置主機",
  da_tip8:
    "此處信息修改僅變更前臺展示，實際變動請前往 DA 控制，變更套餐信息會同時變更其他參數信息",
  ...
  associate_host: "關聯主機",
  web_space: "網頁空間",
  database_space: "數據庫空間",
  not_specify: "不指定",
  capacity_allocation: "容量配置",
  bt_tip1: "需要XFS文件系統，且包含prjquota掛載參數才能使用",
  bt_tip2: "寶塔暫不支持設置流量限額，8.0.4 將支持（目前此處僅用於前臺展示）",
  bt_tip3: "若不指定主機，用戶購買時將自動分配到關聯主機之壹",
  bt_tip4: "按周期比例換算",
  bt_tip5:
    "開啟後，該產品其他續費周期的價格將按照當前續費周期與其他周期的比例進行直接換算",

  /* 产品转移插件 */
  host_transfer_text1: "產品轉移挿件",
  host_transfer_text2:
    "此處展示產品轉移記錄，如需轉移產品，請前往用戶詳情-產品資訊頁執行產品轉移操作",
  ...
  host_transfer_text16:
    "請注意：該產品已關聯其他商品，遷移將自動將所有關聯的產品一起遷移",
  host_transfer_text17: "關聯產品資訊:",
  host_transfer_text18: "產品遷移不會遷移訂單資訊",
  host_transfer_text19: "若存在VPC/安全組/付費系統鏡像，將同步到目標用戶",

  event_promotion_text1: "活動促銷",
  event_promotion_text2: "請輸入活動名稱/備註",
  event_promotion_text3: "新建活動",
  event_promotion_text4: "活動名稱",
  event_promotion_text5: "活動時間",
  event_promotion_text6: "活動範圍",
  event_promotion_text7: "活動狀態",
  event_promotion_text8: "備註",
  event_promotion_text9: "所有使用者",
  event_promotion_text10: "指定使用者",
  event_promotion_text11: "已停用",
  event_promotion_text12: "啟用中",
  event_promotion_text13: "已失效",
  event_promotion_text14: "待生效",
  event_promotion_text15: "活動類型",
  event_promotion_text16: "百分比",
  event_promotion_text17: "滿減",
  event_promotion_text18: "固定金額",
  event_promotion_text19: "折扣比例",
  event_promotion_text20: "滿減金額",
  event_promotion_text21: "達標金額",
  event_promotion_text22: "優惠金額",
  event_promotion_text23: "參與產品",
  event_promotion_text24: "適用使用者",
  event_promotion_text25: "不選擇預設所有使用者",
  event_promotion_text26: "新註冊使用者",
  event_promotion_text27: "僅適用於新註冊使用者",
  event_promotion_text28: "現有使用者",
  event_promotion_text29:
    "只適用於現有的客戶（必須有一個已核驗通過的訂單才可以）",
  event_promotion_text30: "單一使用者一次",
  event_promotion_text31: "單一使用者該活動只能參與一次",
  event_promotion_text32: "週期限制",
  event_promotion_text33: "用戶購買時選擇設定的週期才可使用",
  event_promotion_text34: "請輸入活動名稱",
  event_promotion_text35: "請選擇活動類型",
  event_promotion_text36: "請輸入折扣比例",
  event_promotion_text37: "請輸入滿減金額",
  event_promotion_text38: "請選擇生效時間",
  event_promotion_text39: "請選擇截止時間",
  event_promotion_text40: "選擇活動產品",
  event_promotion_text41: "新增活動",
  event_promotion_text42: "活動詳情",
  event_promotion_text43: "金額必須大於0",

  /* ping_test */
  ping_test: "PING測試",
  ping_test_tip: "此處配置可以發起PING測試的機房位置及IP",
  script_download: "腳本下載",
  script_download_tip: "使用腳本的機器需為X86平臺且已安裝了systemd",
  script_execution_address: "腳本執行地址",
  ping_tip1: "測試地區的IP地址",
  ping_tip2: "發起PING測腳本的地址",
  ping_tip3: "格式錯誤",
