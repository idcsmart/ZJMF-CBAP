    ...
    new Vue({
      data () {
        return {
          ...
          rules: {
            template_id: [
              { pattern: /^[A-Za-z0-9-_]{0,100}$/, message: lang.verify21 + '，' + lang.verify3 + 100, type: 'warning' }
            ],
            ...
            product_url: [{ required: true, message: lang.input + lang.app_scene, type: 'error' }],
            remark: [{ required: true, message: lang.input + lang.scene_des, type: 'error' }],
          },
          country: [],
          loading: false,
          delId: '',
