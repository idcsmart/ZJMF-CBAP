      ...
      data() {
        return {
          ...
          productRules: {
            ...
            profit_percent: [ { validator: this.percentValidator},
              { pattern: /^([1-9]\d*(\.\d{1,2})?|([0](\.([0][1-9]|[1-9]\d{0,1}))))$/, message: lang.upstream_text39, type: 'error' }],
            ...
            profit_type: [{ required: true, message: lang.select + lang.upstream_text74, type: 'error' }],
          },
          productModel: false,
          firstGroup: [],
          secondGroup: [],
        ...
        percentValidator (val) {
          if (val.length === 0) {
            if (this.productData.profit_type === 0) {
              return { result: false, message: `${lang.input}${lang.upstream_text18}`, type: 'error' };
            } else {
              return { result: false, message: `${lang.input}${lang.fixed}${lang.upstream_text73}`, type: 'error' };
            }
          }
