...
<div id="content" class="client-detail hasCrumb" v-cloak>
  ...
  <div class="info-card">
      ...
      <div class="header-btn">
        <div class="left">
          ...
          <div class="com-transparent change_log" @click="changeLog"
            v-if="authList.includes('ClientCreditController::clientCreditList')">
            <t-button theme="primary">{{lang.change_log}}</t-button>
            <span class="txt">{{lang.change_log}}</span>
          </div>
        </div>
        <t-button theme="primary" type="submit" :disabled="data.status===0"
          @click="loginByUser">{{lang.login_as_user}}</t-button>
      </div>
      <div class="info-box">
        <t-row align="middle">
          <t-col :span="6">
    ...
    <t-card>
      ...
      <t-table row-key="1" class="ip-table" :data="data.login_logs" size="medium" :bordered="true" :columns="logColumns"
  ...
  <t-card class="user-info">
    ...
    <div class="footer-btn">
      <t-button theme="primary" :loading="submitLoading" @click="updateUserInfo" type="submit"
        v-if="authList.includes('ClientController::update')">{{lang.hold}}</t-button>
      ...
      <t-button theme="default" variant="base" @click="deleteUser"
        v-if="authList.includes('ClientController::delete')">{{lang.delete}}</t-button>
