const lang_obj = {
  ...
  jump_tip2: "You are leaving",
  jump_tip3: "Please take care of your account and property security.",
  ...
  common_cloud_tip8: "Deactivate when it expires",
  common_cloud_tip9: "Deactivate immediately",
  ...
  appstore_text443: "Please enter a reason for rejection",
  appstore_text444: "submodule",
  appstore_text445: "Home Widget",
  ...
  invoice_text140: "Invoice item",
  invoice_text141: "Invoice style",
  invoice_text142: "Please select invoice item",
  invoice_text143: "New Year's invoice cannot be automatically issued, please contact the administrator",
  invoice_text144: "Invoice Format",
  invoice_text145: "Invoice download",
  invoice_text146: "Flushed red",
  ...
  bt_tip4:
    "After deleting the selected domain name, you will not be able to access the website using this domain name. Do you want to continue?",
  bt_tip5:
    "Please select your application, if the site cannot be accessed normally after setting pseudo-static, please try to empty and save",
  bt_tip6:
    "You can modify the pseudo-static rules, after the modification can be saved",
  bt_tip7: "Please select the version according to your program needs",
  bt_tip8:
    "PHP7 does not support the mysql extension, the default installation of mysqli and mysql-pdo",
  bt_tip9:
    "Some programs need to specify a secondary directory as the run directory, such as ThinkPHP5, Laravel",
  bt_tip10: "Select your running directory, click Save",
  bt_tip11:
    "Anti-cross site attack (open_basedir), prevent hackers from invading through other website directories",
  bt_tip12:
    "If the site is disabled, it will not be accessible, do you really want to disable this site?",
  bt_tip13:
    "The site is about to start, do you really want to enable this site?",
  bt_tip14: "Do you really want to remove the selected directory binding?",
  bt_tip15: "Do you really want to delete this redirect?",
  bt_tip16:
    "Redirect type: indicates that access to the selected domain name or entered path will be redirected to the specified URL?",
  bt_tip17:
    "Destination URL: can fill in the site you need to redirect to, the destination URL must be a normal URL, otherwise it will return an error?",
  bt_tip18:
    "Redirect mode: Use 301 for permanent redirect, use 302 for temporary redirect?",
  bt_tip19:
    "Reserved URI parameter: indicates whether the URL accessed after redirection has subpaths or parameters such as set access to http://b.com redirection to http://a.com",
  Bt_tip20:
    "keep the URI parameters: http://b.com/1.html - > http://a.com/1.html",
  Bt_tip21:
    "don't keep the URI parameters: http://b.com/1.html - > http://a.com",
  bt_tip22: "Example: http://www.bt.cn",
  bt_tip23:
    "After setting the domain name redirection, the 404 redirection of this domain name will be invalid",
  bt_tip24:
    "After batch enabling the currently selected rule, the configured redirect domain/directory will be redirected to the target address. Do you want to continue?",
  bt_tip25:
    "After batch deactivating the currently selected rule, the configured redirect domain/directory will point to the source address. Do you want to continue?",
  bt_tip26:
    "After you batch delete the currently selected rule, the configured redirect domain name/directory will become invalid. Do you want to continue?",
  bt_tip27: "Paste your *.key and *.pem content and save it",
  bt_tip28:
    "If the browser prompts that the certificate chain is incomplete, check whether the PEM certificate is spliced correctly",
  bt_tip29:
    "PEM format certificate = domain name certificate. crt + root certificate (root_bundle).crt",
  bt_tip30:
    "When the SSL default site is not specified, the site with SSL disabled will use HTTPS to access the site with SSL enabled",
  bt_tip31:
    "If HTTPS cannot be used to access port 443 after it is enabled, please check that the security group correctly permits port 443",
  ...
  bt_tip35:
    "Before applying, please ensure that the domain name has been resolved, if not resolved will lead to audit failure",
  bt_tip36:
    "Let's Encrypt free certificate, valid for 3 months, supports multiple domain names. Automatically renewed by default",
  bt_tip37: "Renewal fails if your site uses a CDN or 301 redirect",
  bt_tip38:
    "When the SSL default site is not specified, the site without SSL will use HTTPS to directly access the site with SSL enabled",
  bt_tip39:
    "I need to clear the browser cache to see the effect after turning off forced HTTPS. Continue?",
  bt_tip40:
    "Automatic renewal will be attempted within 1 month from expiration time",
  bt_tip41:
    "Let's Encrypt Free Certificate has been automatically generated for you",
  bt_tip42:
    "If you need to use other SSL, please paste your KEY and PEM contents after switching to other certificates, and then save it",
  bt_tip43:
    "If HTTPS cannot be used to access port 443 after it is enabled, please check that the security group correctly permits port 443",
  bt_tip44:
    "When some ftp clients upload files with Chinese names, the Chinese part of the ftp log is written in garbled characters, which will cause that the Chinese part of the displayed file name cannot be converted",
  bt_tip45:
    "[URL suffix] generally fill in the file suffix, each file suffix use ',' separated, such as: png,jpg",
  bt_tip46:
    "[licensed domain name] The domain name allowed as the source, one domain name per line, such as: www.bt.cn",
  bt_tip47:
    "[Response resource] can be set 404/403 and other status codes, you can also set an effective resource, such as: /security.png",
  bt_tip48:
    "[Allow empty HTTP_REFERER request] Whether to allow direct browser access, if your website access is abnormal, try to enable this feature",
  bt_tip49: "Multiple ips are separated by commas (,)",
  bt_tip50:
    "[REPAIR] Try to use the repair command to repair the damaged table. Only simple repair can be done. If the repair is unsuccessful, please consider using the myisamchk tool",
  bt_tip51:
    "[OPTIMIZE] Run the optimize command to recover unreleased disk space, once a month is recommended",
  bt_tip52:
    "[Convert to InnoDB/MyISAM] Convert table engine, recommend to convert all tables to InnoDB",
  ...
  bt_tip57:
    "Backup size: Backup size includes full backup data size and incremental backup data size",
  bt_tip58:
    "Backup will keep backup data for one week, when backup, detected full backup for one week ago, will be fully backed up again",
  bt_tip59:
    "Do not add multiple backup jobs at the same time; otherwise, the file handles may be opened too many or the memory may burst due to the execution of multiple backup jobs at the same time",
  ...
  bt_tip63:
    "Every time the user opens the website page is logged once. If a user opens the same page for multiple times, the access value accumulates for multiple times. This metric measures website traffic.",
  bt_tip64:
    "The number of computers accessing your website (based on cookies), which measures the number of unique visitors.",
  bt_tip65:
    "Number of unique ip visits to your website during the current period.",
  bt_tip66:
    "The total amount of response traffic to your website during the current time period. Includes excluded requests.",
  bt_tip67:
    "The total number of requests to your site during the current time period includes requests that have been deferred.",
  bt_tip68:
    "The amount of real-time traffic to your website in the current 10 seconds. Includes excluded requests.",
  bt_tip69:
    "Number of live requests to your website in the current 10 seconds. Includes excluded requests.",
  bt_tip70:
    "After enabling the selected FTP account, access to the FTP account is restored. Do you want to continue?",
  bt_tip71:
    "After deactivating the selected FTP account, the FTP account will lose access. Do you want to continue?"
};
