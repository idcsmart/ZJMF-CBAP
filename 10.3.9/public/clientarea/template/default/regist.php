...
<html lang="en" theme-color="default" theme-mode>
  <head>
    ...
    <link
      rel="stylesheet"
      href="/{$template_catalog}/template/{$themes}/css/regist.css"
    />
    <link
      rel="stylesheet"
          ...
          <div class="container-before">
            <div class="login">
              ...
              <div class="login-form">
                <div class="login-top">
                  <div
                    v-if="commonData.register_email == 1"
                    class="login-email"
                  ...
                  <div
                    v-if="commonData.register_phone == 1"
                    class="login-phone"
                    :class="!isEmailOrPhone? 'active':null"
                ...
                <div
                  class="form-main"
                  v-if="commonData.register_email == 1 || commonData.register_phone == 1"
                >
                  <div class="form-item">
                    <el-input
                      v-if="isEmailOrPhone"
                      v-model="formData.email"
                      :placeholder="lang.login_email"
                    ></el-input>
                    <el-input
                      v-else
                  ...
                  <template
                    v-if="commonData.code_client_phone_register == 1 && !isEmailOrPhone"
                  >
                    <div
                      class="form-item code-item"
                      v-if="!(commonData.code_client_email_register==0 && isEmailOrPhone)"
                    >
                      <!-- 手机验证码 -->
                      <el-input
                        v-if="!isEmailOrPhone"
                  ...
                  <template
                    v-if="commonData.code_client_email_register == 1 && isEmailOrPhone"
                  >
                  ...
                  <div class="read-item" v-if="checked1">
                    <el-input
                      :placeholder="lang.tip5"
                      v-model="customfield.sale_number"
                    ></el-input>
                  </div>
                  {/if} {/foreach}
                  ...
                  <div class="form-item">
                    <el-button
                      ...
                      class="login-btn"
                      @click="doRegist"
                      >{{ lang.regist_to_login }}</el-button
                    >
                  </div>
                </div>
              </div>
