...
class PackageValidate extends Validate
{
	protected $rule = [
        ...
        'dcim_server_group_id'          => 'require|integer',
        'in_bw'                         => 'require|number|between:0,30000',
        'out_bw'                        => 'require|number|between:0,30000',
        'ip_num'                        => 'require|number|between:1,999999',
        'ip_group'                      => 'number',
        'custom_param'                  => 'length:0,65535',
        'traffic_enable'                => 'require|in:0,1',
        'flow'                          => 'requireIf:traffic_enable,1|number|between:0,99999999',
    ...
    protected $message  =   [
        ...
        'dcim_server_group_id.require'          => 'please_input_dcim_server_group_id',
        'dcim_server_group_id.integer'          => 'dcim_server_group_id_must_be_number',
    ...
    protected $scene = [
        'create' => ['product_id','name','description','data_center_id','dcim_server_group_id','in_bw','out_bw','ip_num','ip_group','custom_param','traffic_enable','flow','traffic_bill_type','onetime_fee','month_fee','quarter_fee','half_year_fee','year_fee','two_year','three_year'],
    ];

    public function sceneEdit(){
        return $this->only(['id','name','description','data_center_id','dcim_server_group_id','in_bw','out_bw','ip_num','ip_group','custom_param','traffic_enable','flow','traffic_bill_type','onetime_fee','month_fee','quarter_fee','half_year_fee','year_fee','two_year','three_year'])
