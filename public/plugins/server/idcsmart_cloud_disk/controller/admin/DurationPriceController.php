...
use server\idcsmart_cloud_disk\validate\DurationPriceValidate;

/**
 * @title 魔方云磁盘配置周期价格
 * @desc 魔方云磁盘配置周期价格
 * @use server\idcsmart_cloud_disk\controller\admin\DurationPriceController
 */
class DurationPriceController{
	 ...
	 * @title 周期价格显示
	 * @desc 周期价格显示
	 * @url /admin/v1/idcsmart_cloud_disk/duration_price
	 * @method  GET
	 * @author theworld
	 * @version v1
     ...
     * @return  float list[].disk_ratio - 磁盘比例
	 */
     ...
     * @param float data[].disk_ratio - 磁盘比例 require
	 */
