<!-- 页面独有样式 -->
<link rel="stylesheet" href="/plugins/server/common_cloud/template/clientarea/css/cloudList.css">
<div id="cloudList">
  <!-- 自己的东西 -->
  <div class="main-card">
...
<script src="/plugins/server/common_cloud/template/clientarea/js/cloudList.js"></script>
