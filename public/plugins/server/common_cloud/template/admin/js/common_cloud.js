const template = document.getElementsByClassName('common-cloud')[0]
...
new Vue({
    ...
    return {
      ...
      packageRules: {
        ...
        in_bw: [
          ...
          {
            pattern: /^[0-9]*$/, message: lang.input + '0-9999999' + lang.verify2, type: 'warning'
          },
          {
            validator: val => val >= 0 && val <= 9999999, message: lang.input + '0-9999999' + lang.verify2, type: 'warning'
          }
        ],
        out_bw: [
  ...
  methods: {
    ...
    addPackage () {
      ...
      this.packageForm.cpu = ''
      this.packageForm.memory = ''
      this.packageForm.system_disk_size = ''
