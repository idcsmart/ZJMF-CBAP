 ...
 * @title 通用云镜像
 * @desc 通用云镜像
 * @use server\common_cloud\controller\home\ImageController
 */
class ImageController{
	 ...
	 * @title 获取可用操作系统
	 * @desc 获取可用操作系统
	 * @url /console/v1/product/:id/common_cloud/image
	 * @method  GET
	 * @author hh
	 * @version v1
	 ...
	 * @title 检查产品是够购买过镜像
	 * @desc 检查产品是够购买过镜像
	 * @url /console/v1/common_cloud/:id/image/check
	 * @method GET
	 * @author hh
	 * @version v1
	 ...
	 * @title 生成购买镜像订单
	 * @desc 生成购买镜像订单
	 * @url /console/v1/common_cloud/:id/image/order
	 * @method POST
	 * @author hh
	 * @version v1
	 * @param   int id - 产品ID require
