...
use server\common_cloud\validate\ImageValidate;
use server\common_cloud\logic\ImageLogic;

/**
 * @title 通用云镜像管理
 * @desc 通用云镜像管理
 * @use server\common_cloud\controller\admin\ImageController
 */
class ImageController{
	 ...
	 * @title 镜像列表
	 * @desc 镜像列表
	 * @url /admin/v1/common_cloud/image
	 * @method  GET
	 * @author hh
	 * @version v1
	 ...
	 * @title 拉取操作系统
	 * @desc 拉取操作系统
	 * @url /admin/v1/common_cloud/image/sync
	 * @method  GET
	 * @author hh
	 * @version v1
	...
	public function getImage(){
		...
		$result = ImageLogic::getProductImage($param['product_id']);
		return json($result);
	}
