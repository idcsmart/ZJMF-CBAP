 ...
 * @title 实例管理
 * @desc 实例管理
 * @use server\idcsmart_cloud\controller\home\CloudController
 */
class CloudController{
	 ...
	 * @title 获取实例详情
	 * @desc 获取实例详情
	 * @url /console/v1/idcsmart_cloud/:id
	 * @method  GET
	 * @author hh
	 * @version v1
	 * @param   int $id - 产品ID
     ...
     * @return  int cal.cpu - CPU
     * @return  int cal.memory - 内存(MB)
     * @return  int cal.disk_size - 硬盘
     * @return  int bw.id - 带宽ID
     * @return  int bw.bw - 带宽
     * @return  int bw.flow - 流量(GB)
	 ...
	 * @title 开机
	 * @desc 开机
	 * @url /console/v1/idcsmart_cloud/:id/on
	 * @method  POST
	 * @author hh
	 * @version v1
	 ...
	 * @title 关机
	 * @desc 关机
	 * @url /console/v1/idcsmart_cloud/:id/off
	 * @method  POST
	 * @author hh
	 * @version v1
	 * @param   int id - 产品ID require
	 ...
	 * @title 重启
	 * @desc 重启
	 * @url /console/v1/idcsmart_cloud/:id/reboot
	 * @method  POST
	 * @author hh
	 * @version v1
	 * @param   int id - 产品ID require
	 ...
	 * @title 强制关机
	 * @desc 强制关机
	 * @url /console/v1/idcsmart_cloud/:id/hard_off
	 * @method  POST
	 * @author hh
	 * @version v1
	 * @param   int id - 产品ID require
	 ...
	 * @title 强制重启
	 * @desc 强制重启
	 * @url /console/v1/idcsmart_cloud/:id/hard_reboot
	 * @method  POST
	 * @author hh
	 * @version v1
	 * @param   int id - 产品ID require
	 ...
	 * @title 获取控制台地址
	 * @desc 获取控制台地址
	 * @url /console/v1/idcsmart_cloud/:id/vnc
	 * @method  POST
	 * @author hh
	 * @version v1
	 ...
	 * @title 获取实例状态
	 * @desc 获取实例状态
	 * @url /console/v1/idcsmart_cloud/:id/status
	 * @method  GET
	 * @author hh
	 * @version v1
	 * @param   int id - 产品ID require
	 ...
	 * @title 重置密码
	 * @desc 重置密码
	 * @url /console/v1/idcsmart_cloud/:id/reset_password
	 * @method  POST
	 * @author hh
	 * @version v1
	 * @param   int id - 产品ID require
	 ...
	 * @title 救援模式
	 * @desc 救援模式
	 * @url /console/v1/idcsmart_cloud/:id/rescue
	 * @method  POST
	 * @author hh
	 * @version v1
	 * @param   int id - 产品ID require
	 ...
	 * @title 退出救援模式
	 * @desc 退出救援模式
	 * @url /console/v1/idcsmart_cloud/:id/rescue/exit
	 * @method  POST
	 * @author hh
	 * @version v1
	 * @param   int id - 产品ID require
	 ...
	 * @title 重装系统
 	 * @desc 重装系统
	 * @url /console/v1/idcsmart_cloud/:id/reinstall
	 * @method  POST
	 * @author hh
	 * @version v1
	 * @param   int id - 产品ID require
	 ...
	 * @title 获取图表数据
	 * @desc 获取图表数据
	 * @url /console/v1/idcsmart_cloud/:id/chart
	 * @method  GET
	 * @author hh
	 * @version v1
	 * @param   int id - 产品ID require
	 ...
	 * @title 获取当前VPC网络
	 * @desc 获取当前VPC网络
	 * @url /console/v1/idcsmart_cloud/:id/vpc
	 * @method  GET
	 * @author hh
	 * @version v1
	 * @param   int id - 产品ID
	 ...
	 * @title 获取网络流量
	 * @desc 获取网络流量
	 * @url /console/v1/idcsmart_cloud/:id/flow
	 * @method  GET
	 * @author hh
	 * @version v1
	 * @param   int id - 产品ID require
	 ...
	 * @title 获取实例磁盘
	 * @desc 获取实例磁盘
	 * @url /console/v1/idcsmart_cloud/:id/disk
	 * @method  GET
	 * @author theworld
	 * @version v1
	 * @param   int id - 产品ID require
	 ...
	 * @title 快照列表
	 * @desc 快照列表
	 * @url /console/v1/idcsmart_cloud/:id/snapshot
	 * @method  GET
	 * @author hh
	 * @version v1
	 * @param   int id - 产品ID require
	 ...
	 * @title 快照还原
	 * @desc 快照还原
	 * @url /console/v1/idcsmart_cloud/:id/snapshot/restore
	 * @method  POST
	 * @author hh
	 * @version v1
	 * @param   int id - 产品ID require
	 ...
	 * @title 删除快照
	 * @desc 删除快照
	 * @url /console/v1/idcsmart_cloud/:id/snapshot/:snapshot_id
	 * @method  DELETE
	 * @author hh
	 * @version v1
	 * @param   int id - 产品ID require
	 ...
	 * @title 备份列表
	 * @desc 备份列表
	 * @url /console/v1/idcsmart_cloud/:id/backup
	 * @method  GET
	 * @author hh
	 * @version v1
	 * @param   int id - 产品ID require
	 ...
	 * @title 备份还原
	 * @desc 备份还原
	 * @url /console/v1/idcsmart_cloud/:id/backup/restore
	 * @method  POST
	 * @author hh
	 * @version v1
	 * @param   int id - 产品ID require
	 ...
	 * @title 删除备份
	 * @desc 删除备份
	 * @url /console/v1/idcsmart_cloud/:id/backup/:backup_id
	 * @method  DELETE
	 * @author hh
	 * @version v1
	 * @param   int id - 产品ID require
	 ...
	 * @title 模板列表
	 * @desc 模板列表
	 * @url /console/v1/idcsmart_cloud/:id/template
	 * @method  GET
	 * @author hh
	 * @version v1
	 * @param   int id - 产品ID require
	...
	public function template(){
		...
		try{
			...
			$result = $CloudLogic->templateList($param);
			return json($result);
		}catch(\Exception $e){
			return json(['status'=>400, 'msg'=>$e->getMessage()]);
		}
	 ...
	 * @title 删除模板
	 * @desc 删除模板
	 * @url /console/v1/idcsmart_cloud/:id/template/:template_id
	 * @method  DELETE
	 * @author theworld
	 * @version v1
	 * @param   int id - 产品ID require
	 ...
	 * @title 日志
	 * @desc 日志
	 * @url /console/v1/idcsmart_cloud/:id/log
	 * @method  GET
	 * @author hh
	 * @version v1
     * @param int id - 产品ID
	 ...
	 * @title 获取升降级套餐价格
	 * @desc 获取升降级套餐价格
	 * @url /console/v1/idcsmart_cloud/:id/package/upgrade
	 * @method  GET
	 * @author hh
	 * @version v1
	 * @param   int id - 产品ID require
	...
	public function calUpgradePackagePrice(){
		...
		$HostLinkModel = new HostLinkModel();
		$result = $HostLinkModel->calUpgradePackagePrice($param);
		return json($result);
	}
	 ...
	 * @title 生成升降级套餐订单
	 * @desc 生成升降级套餐订单
	 * @url /console/v1/idcsmart_cloud/:id/package/upgrade/order
	 * @method  POST
	 * @author hh
	 * @version v1
	 * @param   int id - 产品ID require
	...
	public function createUpgradePackageOrder(){
		...
		$HostLinkModel = new HostLinkModel();
		$result = $HostLinkModel->createUpgradePackageOrder($param);
		return json($result);
	}
	 ...
	 * @title 获取魔方云是否救援系统
	 * @desc 获取魔方云是否救援系统
	 * @url console/v1/idcsmart_cloud/:id/remote_info
	 * @method  GET
	 * @author hh
	 * @version v1
	 * @param   int id - 产品ID require
	 ...
	 * @title 获取弹性IP列表
	 * @desc 获取弹性IP列表
	 * @url /console/v1/idcsmart_cloud/:id/ip
	 * @method  GET
	 * @author hh
	 * @version v1
     * @param int id - 产品ID
