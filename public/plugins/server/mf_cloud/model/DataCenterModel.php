...
class DataCenterModel extends Model{
    ...
    public function orderPage($param){
        ...
        // 获取配置
        $config = ConfigModel::field('host_prefix,host_length,support_ssh_key,support_normal_network,support_vpc_network,support_public_ip,backup_enable,snap_enable')
                ->where($where)
                ->find();
