...
class ConfigLimitValidate extends Validate{
    ...
    protected $rule = [
        ...
        'min_memory'        => 'require|integer|between:1,512',
        'max_memory'        => 'require|integer|between:1,512|gt:min_memory',
    ];
    ...
    protected $message = [
        ...
        'min_memory.between'            => 'memory_min_value_format_error',
        'max_memory.require'            => 'please_input_memory_max_value',
        'max_memory.integer'            => 'please_input_memory_max_value',
        'max_memory.between'            => 'memory_max_value_format_error',
