...
<div id="content" class="promo-code" v-cloak>
  <t-card class="list-card-container">
    <div class="common-header">
      ...
      <div class="client-search">
        <t-input v-model="params.keywords" @keyup.enter.native="seacrh" :placeholder="`${lang.input + lang.coupon_code}`" :on-clear="clearKey" clearable>
        </t-input>
        <t-select v-model="params.type" :placeholder="lang.select + lang.coupon_code_type" clearable>
    ...
    :hide-sort-tips="true" :max-height="maxHeight" @row-click="goDetail">
    ...
    <t-pagination :total="total" v-if="total" :page-size="params.limit" :current="params.page" :page-size-options="pageSizeOptions" @change="changePage" />
  </t-card>
  <!-- 启用/停用 -->
  ...
  <t-dialog :header="recordTit" :visible.sync="recordDialog" :footer="false" width="800px">
    ...
    <t-pagination :total="recordTotal" v-if="recordTotal" :page-size="recordParams.limit" :current="recordParams.page" :page-size-options="recordPage" @change="changeRecord" />
  </t-dialog>
</div>
