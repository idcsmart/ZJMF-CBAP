          ...
          <div class="card-body">
            ...
            <div class="tab-content mt-4">
              <div class="help-block">
                系统中所有销售的产品，包括已删除或暂停的产品<a class="text-primary">帮助文档</a>
              </div>
              <ul class="nav nav-tabs" id="myTab" role="tablist">
                <li class="nav-item" role="presentation">
                  <a class="nav-link active" id="pending-tab" data-toggle="tab" href="#pending" role="tab" aria-controls="pending" aria-selected="true">待处理</a>
                </li>
                <li class="nav-item" role="presentation">
                  <a class="nav-link" id="reply-tab" data-toggle="tab" href="#reply" role="tab" aria-controls="reply" aria-selected="false">已回复</a>
                </li>
                <li class="nav-item" role="presentation">
                  <a class="nav-link" id="await-tab" data-toggle="tab" href="#await" role="tab" aria-controls="await" aria-selected="false">等待中</a>
                </li>
                <li class="nav-item" role="presentation">
                  <a class="nav-link" id="close-tab" data-toggle="tab" href="#close" role="tab" aria-controls="close" aria-selected="false">关闭</a>
                </li>
                <li class="nav-item" role="presentation">
