...
<body>
        ...
        <el-main>
          ...
          <div class="clid-box">
            ...
            <el-table :data="cildAccountList" style="width: 100%">
              ...
              <el-table-column prop="username" label="账户 " min-width="150"></el-table-column>
              <el-table-column prop="date" label="上次登录时间" min-width="160">
  ...
  <script src="/plugins/addon/idcsmart_sub_account/template/clientarea/js/childAccount.js"></script>
