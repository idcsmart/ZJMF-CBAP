...
<link rel="stylesheet" href="/plugins/addon/idcsmart_help/template/admin/css/common/reset.css" />
        ...
        <div id="content" class="help" v-cloak>
            ...
            <div class="help_card">
              <div class="help_tabs flex">
                <div class="tabs flex">
                  ...
                  <div class="tabs_item" @click="changetabs(2)">首页管理</div>
                  <div class="tabs_item" @click="changetabs(3)">分类管理</div>
                </div>
                <div class="searchbar com-search">
                  <t-input v-model="params.keywords" @change="onEnter" class="search-input" placeholder="请输入你需要搜索的内容"
                    clearable>
                  </t-input>
              ...
              <div class="help_table">
                <t-table hover row-key="index" :maxHeight="140" :pagination="pagination" :data="list" :columns="columns"
                  @Change="changepages" max-Height="600px">
          ...
          <t-dialog header="文档分类管理" placement="center" :visible.sync="visible" :onCancel="onCancel"
            :onEscKeydown="onKeydownEsc" :onCloseBtnClick="onClickCloseBtn" :onClose="close" width="70%"
            :confirm-btn='null' cancel-btn="关闭">
            <t-table :key="key" bordered row-key="index" :maxHeight="140" :data="typelist" :columns="columns2"
              maxHeight="80%">
              <template #name="slotProps">
                <t-input placeholder="请输入" v-model="slotProps.row.name" :disabled="!slotProps.row.isedit"
                  style="width: 250px;" />
              </template>
              ...
              <template #op="slotProps">
                ...
                <div v-else>
                  <t-icon name="save" color="#0052D9" style="margin-right: 10px;"
                    @click="savehandleClickadd(slotProps.row.name)"></t-icon>
