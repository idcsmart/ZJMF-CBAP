  ...
  window.onload = function () {
      ...
      new Vue({
          ...
          methods: {
              ...
              //删除商品
               deleteRow(data){
                  ...
                  let mydialog = this.$dialog({
                      ...
                      onConfirm: ({ e }) => {
                          deleteRefund(data.row.id).then((res)=>{
                              _that.getList();
                              _that.$message.info({
                                  ...
                                  attach: '#t-content-message-toggle',
                              });
                              mydialog.hide();
                          });
                      },
              ...
              to_add(data){
                  if(data){
                      location.href = `add_refund_product.html?id=${data.row.id}`
                  }else {
                      location.href = 'add_refund_product.html'
                  }
              },
              //获取停用列表
              async getReasonList(){
