...
<div id="content" class="template" v-cloak>
  <t-card class="list-card-container">
    ...
    <div class="detail-row">
      ...
      <div class="detail-item no-wrap">
        <span class="detail-label">{{lang.order_current_status}} :</span>
    ...
    <t-list class="reply-list" :style="{ height: replyListHeight }">
      <t-list-item v-for="(item, index) in orderDetailData.replies" :key="index">
        <template>
          ...
          :avatar="item.type==='Client'?'./img/client.png':'./img/admin.png'" 
          :content="item.content" :author="item.client_name?item.client_name:item.admin_name">
            <template #actions>
