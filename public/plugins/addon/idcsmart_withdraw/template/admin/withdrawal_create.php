                ...
                <t-row :gutter="{ xs: 8, sm: 16, md: 24, lg: 32, xl: 32, xxl: 60 }" class="no-label">
                  <t-col :xs="12" :xl="3" :md="6">
                    ...
                    <t-form-item name="source" label="">
                      <t-select v-model="formData.source" :placeholder="lang.select+lang.withdrawal_source"
                  ...
                  <t-col :xs="12" :xl="3" :md="6">
                    ...
                    <t-form-item name="method" label="">
                      <t-select v-model="formData.method" :placeholder="lang.select+lang.withdrawal_way" multiple
                        :popup-props="popupProps">
                  ...
                  <t-col :xs="12" :xl="3" :md="6">
                    ...
                    <t-form-item name="process" label="">
                      <t-select v-model="formData.process" :placeholder="lang.select+lang.withdrawal_process"
                        :popup-props="popupProps">
                ...
                <t-row :gutter="{ xs: 8, sm: 16, md: 24, lg: 32, xl: 32, xxl: 60 }" class="no-label">
                  <t-col :xs="12" :xl="3" :md="6">
                    ...
                    },
                    {
                      ...
                      <t-input v-model="formData.min" :placeholder="lang.input+lang.min_money_limit"
                        @change="changeMoney">
                      </t-input>
                ...
                <t-row :gutter="{ xs: 8, sm: 16, md: 24, lg: 32, xl: 32, xxl: 60 }" class="no-label">
                  <t-col :xs="12" :xl="3" :md="6">
                    ...
                    <t-form-item name="cycle" label="">
                      <t-select v-model="formData.cycle" :placeholder="lang.select+lang.withdrawal_cycle_limit"
                        :popup-props="popupProps">
                ...
                <t-row :gutter="{ xs: 8, sm: 16, md: 24, lg: 32, xl: 32, xxl: 60 }" class="no-label">
                  <t-col :xs="12" :xl="3" :md="6">
                    ...
                    <t-form-item name="withdraw_fee_type" label="">
                      <t-select v-model="formData.withdraw_fee_type" :placeholder="lang.select+lang.withdraw_fee_type"
                        :popup-props="popupProps">
                        <t-option :value="item.value" :label="item.label" v-for="item in withdraw_fee"
                          :key="item.value">
                        </t-option>
                      </t-select>
                    </t-form-item>
