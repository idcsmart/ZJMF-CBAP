...
class IdcsmartNewsModel extends Model
{
    ...
    public function idcsmartNewsDetail($id, $app = '')
    {
        ...
        $idcsmartNews = $this
            ->field('id,addon_idcsmart_news_type_id,title,content,keywords,attachment,create_time,hidden')
        ...
        if($app=='home'){
            ...
            unset($idcsmartNews['addon_idcsmart_news_type_id'], $idcsmartNews['hidden']);
        }else{
