<?php
namespace gateway\stripe_wx;

use app\common\lib\Plugin;
use think\facade\Db;

class StripeWx extends Plugin
{

    public $info = array(
        'name'        => 'StripeWx', //Demo插件英文名，改成你的插件英文就行了
        'title'       => '(stripe)微信二维码支付插件',
        'description' => '(stripe)微信二维码支付插件',
        'author'      => 'idcsmart',
        'version'     => '1.0',  // 必填 插件版本
        'help_url'    => '', // 选填 申请链接
        'author_url'  => '', // 选填 作者链接
    ...
    public function StripeWxHandle($param)
    {
        ...
        require_once(dirname(__DIR__) . "/stripe_wx/stripe-php/init.php");
        //订单标题，必填
        ...
        $url = "https://api.qrserver.com/v1/create-qr-code/?size=200x200&data=" . $result->wechat->qr_code_url;
