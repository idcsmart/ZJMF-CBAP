...
namespace gateway\wx_pay_h5\controller;


use gateway\wx_pay_h5\behavior\ConfigController;
use gateway\wx_pay_h5\lib\WxPayApi;
use gateway\wx_pay_h5\lib\WxPayNotify;
use gateway\wx_pay_h5\lib\WxPayOrderQuery;
...
//        Log::DEBUG("query:" . json_encode($result));
    ...
    private function orderHandle($data)
    {
        ...
        $up_data['gateway'] = 'WxPayH5';                    //支付网关名称
