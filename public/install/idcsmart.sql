...
INSERT INTO `idcsmart_auth` (`id`, `title`, `url`, `order`, `parent_id`) VALUES (12, 'auth_user_log', '', 12, 1);
...
INSERT INTO `idcsmart_auth_rule` (`id`, `name`, `title`) VALUES (105, 'app\\admin\\controller\\MenuController::getAdminMenu', 'auth_rule_get_admin_menu');

INSERT INTO `idcsmart_auth_rule` (`id`, `name`, `title`) VALUES (106, 'app\\admin\\controller\\MenuController::getHomeMenu', 'auth_rule_get_home_menu');

INSERT INTO `idcsmart_auth_rule` (`id`, `name`, `title`) VALUES (107, 'app\\admin\\controller\\MenuController::saveAdminMenu', 'auth_rule_save_admin_menu');

INSERT INTO `idcsmart_auth_rule` (`id`, `name`, `title`) VALUES (108, 'app\\admin\\controller\\MenuController::saveHomeMenu', 'auth_rule_save_home_menu');

INSERT INTO `idcsmart_auth` (`id`, `title`, `url`, `order`, `parent_id`) VALUES (96, 'auth_nav_management', '', 96, 49); 

INSERT INTO `idcsmart_auth` (`id`, `title`, `url`, `order`, `parent_id`) VALUES (97, 'auth_view', '', 97, 96); 
...
INSERT INTO `idcsmart_auth` (`id`, `title`, `url`, `order`, `parent_id`) VALUES (98, 'auth_view', '', 98, 96); 
...
INSERT INTO `idcsmart_configuration`(`setting`,`value`,`create_time`,`update_time`,`description`) VALUES ('maintenance_mode_message','维护模式',0,0,'维护模式内容');
INSERT INTO `idcsmart_configuration`(`setting`,`value`,`create_time`,`update_time`,`description`) VALUES ('website_name','智简魔方',0,0,'网站名称');
INSERT INTO `idcsmart_configuration`(`setting`,`value`,`create_time`,`update_time`,`description`) VALUES ('website_url','',0,0,'网站域名地址');
INSERT INTO `idcsmart_configuration`(`setting`,`value`,`create_time`,`update_time`,`description`) VALUES ('terms_service_url','',0,0,'服务条款地址');
...
INSERT INTO `idcsmart_configuration`(`setting`,`value`,`create_time`,`update_time`,`description`) VALUES ('captcha_client_register','0',0,0,'客户注册图形验证码开关  1开启，0关闭');
...
INSERT INTO `idcsmart_configuration`(`setting`,`value`,`create_time`,`update_time`,`description`) VALUES ('captcha_client_login_error','0',0,0,'客户登录失败图形验证码开关  1开启，0关闭');
...
INSERT INTO `idcsmart_configuration`(`setting`,`value`,`create_time`,`update_time`,`description`) VALUES ('currency_code','USD',0,0,'货币代码');
...
INSERT INTO `idcsmart_configuration`(`setting`,`value`,`create_time`,`update_time`,`description`) VALUES ('task','1',0,0,'任务队列锁');
...
INSERT INTO `idcsmart_configuration`(`setting`,`value`,`create_time`,`update_time`,`description`) VALUES ('send_sms_global','Submail',0,0,'默认短信发送国际接口');
...
INSERT INTO `idcsmart_configuration`(`setting`,`value`,`create_time`,`update_time`,`description`) VALUES ('cron_lock_last_time','1660716603',0,0,'定时任务最后执行时间');
INSERT INTO `idcsmart_configuration`(`setting`,`value`,`create_time`,`update_time`,`description`) VALUES ('cron_lock_day_last_time','1660665789',0,0,'每天执行一次定时任务最后执行时间');
INSERT INTO `idcsmart_configuration`(`setting`,`value`,`create_time`,`update_time`,`description`) VALUES ('task_time','1660720496',0,0,'队列执行时长，然后程序结束');
INSERT INTO `idcsmart_configuration`(`setting`,`value`,`create_time`,`update_time`,`description`) VALUES ('cron_lock_five_minute_last_time','1660716603',0,0,'每五分钟执行一次定时任务最后执行时间');
INSERT INTO `idcsmart_configuration`(`setting`,`value`,`create_time`,`update_time`,`description`) VALUES ('cron_lock_start_time','1660716603',0,0,'定时任务开始执行时间');
...
INSERT INTO `idcsmart_configuration`(`setting`,`value`,`create_time`,`update_time`,`description`) VALUES ('currency_suffix','USD',0,0,'货币后缀');
INSERT INTO `idcsmart_configuration`(`setting`,`value`,`create_time`,`update_time`,`description`) VALUES ('code_client_email_register','0',0,0,'邮箱注册数字验证码开关:1开启0关闭');
...
CREATE TABLE `idcsmart_nav` (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  KEY `parent_id` (`parent_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=COMPACT COMMENT='默认导航表';
...
INSERT INTO `idcsmart_nav`(`id`,`type`,`name`,`url`,`icon`,`parent_id`,`order`,`module`,`plugin`) VALUES (25,'admin','nav_plugin','','control-platform',0,26,'','');
...
INSERT INTO `idcsmart_nav`(`id`,`type`,`name`,`url`,`icon`,`parent_id`,`order`,`module`,`plugin`) VALUES (27,'home','nav_index','index.html','',0,0,'','');
INSERT INTO `idcsmart_nav`(`id`,`type`,`name`,`url`,`icon`,`parent_id`,`order`,`module`,`plugin`) VALUES (28,'home','nav_host_list','host.html','',0,1,'','');
INSERT INTO `idcsmart_nav`(`id`,`type`,`name`,`url`,`icon`,`parent_id`,`order`,`module`,`plugin`) VALUES (29,'home','nav_finance_info','finance.html','',0,2,'','');
INSERT INTO `idcsmart_nav`(`id`,`type`,`name`,`url`,`icon`,`parent_id`,`order`,`module`,`plugin`) VALUES (30,'home','nav_account_info','account.html','',0,3,'','');
INSERT INTO `idcsmart_nav`(`id`,`type`,`name`,`url`,`icon`,`parent_id`,`order`,`module`,`plugin`) VALUES (31,'home','nav_security','security.html','',0,4,'','');
INSERT INTO `idcsmart_nav`(`id`,`type`,`name`,`url`,`icon`,`parent_id`,`order`,`module`,`plugin`) VALUES (32,'admin','nav_navigation','navigation.html','',11,28,'','');
