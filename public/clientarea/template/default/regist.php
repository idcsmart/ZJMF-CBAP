            ...
            <div class="container-before">
                <div class="login">
                    ...
                    <div class="login-form">
                        <div class="login-top">
                            <div v-if="commonData.register_email == 1" class="login-email" :class="isEmailOrPhone? 'active':null" @click="isEmailOrPhone = true">{{lang.login_email}}
                            </div>
                            <div v-if="commonData.register_phone == 1" class="login-phone" :class="!isEmailOrPhone? 'active':null" @click="isEmailOrPhone = false">{{lang.login_phone}}
                            </div>
                        </div>
                        <div class="form-main" v-if="commonData.register_email == 1 || commonData.register_phone == 1">
                            <div class="form-item">
                                ...
                                <el-input v-else class="input-with-select" v-model="formData.phone" :placeholder="lang.login_phone">
