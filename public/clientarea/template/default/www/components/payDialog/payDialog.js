          ...
          @close="zfClose" :title="'订单ID-' + zfData.orderId">
            <div class="dialog-form">
                ...
                <div v-show="!isShowPay" v-loading="loading" style="min-height:100px">
                   <img  style="width:1.5rem;height:1.5rem;margin-top:.25rem;margin-bottom:.25rem" v-show="!isShowPay" src="./img/common/payloading.png" />
                </div>
                ...
                <div class="f-btn" v-show="!isNotPayWay">
                  <span>
                    <span class="total">
                    <img src="./img/common/money.png" alt="" class="img" /> 
