...
<body>
              ...
              <el-tabs v-model="activeIndex" @tab-click="handleClick">
                <el-tab-pane :label="lang.account_menu1" name="1">
                  <div class="box-top">
                    <div class="right-name">
                      ...
                      <div class="attestation-status" v-if="false" v-show="attestationStatusInfo.iocnShow" @click="handelAttestation">
                ...
                <el-tab-pane :label="lang.account_menu2" name="2">
                  ...
                  <div class="mobel">
                    ...
                    <img v-show="isShowBackTop" class="back-top-img" @click="goBackTop" src="./img/common/toTop.png">
                  </div>
  ...
  <script src="/{$template_catalog}/template/{$themes}/components/authenticationTipDialog/authenticationDialog.js"></script>
</body>
