        ...
        <el-main>
          ...
          <div class="main-card security-group">
            ...
            <div class="create-api-dialog">
              <el-dialog width="5.2rem" :visible.sync="isShowCj" :show-close=false @close="cjClose">
                <p class="dia-tit">{{optTitle}}</p>
                <el-form :model="singleForm" ref="singleForm" v-if="isShowCj" label-width=".8rem" :rules="rules" label-position="left">
                  ...
                  <el-form-item :label="lang.common_cloud_label13" prop="port">
                    <el-input :placeholder="`${lang.security_tip2}`" v-model="singleForm.port"></el-input>
                  </el-form-item>
