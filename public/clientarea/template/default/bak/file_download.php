{include file="header"}
<!-- 页面独有样式 -->
<link rel="stylesheet" href="/{$template_catalog}/template/{$themes}/css/file_download.css">
</head>
...
<body>
  ...
  <script src="/{$template_catalog}/template/{$themes}/api/file_download.js"></script>
  <script src="/{$template_catalog}/template/{$themes}/js/file_download.js"></script>
