{include file="header"}
<!-- 页面独有样式 -->
<link rel="stylesheet" href="/{$template_catalog}/template/{$themes}/css/dcimOrder.css">
</head>
...
<body>
                            ...
                            <div class="order-right">
                                ...
                                <div class="order-right-footer">
                                    ...
                                    <div class="bottom-btns">
                                        <el-button class="car-btn" @click="addCart">购物车</el-button>
    ...
    <script src="/{$template_catalog}/template/{$themes}/api/dcimOrder.js"></script>
    <script src="/{$template_catalog}/template/{$themes}/js/dcimOrder.js"></script>
