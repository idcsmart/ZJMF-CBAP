                        ...
                        <div>
                            <div class="banner">
                                ...
                                <div class="banner-search" v-if="isShow"  v-show="isShowText">
                                    <el-input class="banner-input" v-model="email"
                                        :disabled="accountData.email?true:false" :placeholder="lang.ali_tips1">
                            ...
                            <div class="ali-main">
                                <div class="ali-main-card">
                                    ...
                                    <div class="card-recharge">
                                        ...
                                        <el-input class="recharge-input"
                                            :placeholder="lang.ali_tips4+ commonData.currency_prefix +commonData.recharge_min +commonData.currency_suffix"
                                            v-model="czData.amount"
                                            @keyup.native="czData.amount=oninput(czData.amount)">
                                    ...
                                    <div class="card-choice">
                                        <div class="choice-item" :class="item.id === activeId?'active':''"
                                            v-for="item in money" :key="item.id"
                                            @click="activeId = item.id;czData.amount = item.num">
                                    ...
                                    <el-form :model="czData" label-position="top">
                                        <el-form-item :label="lang.ali_label1">
                                            <el-select @change="czSelectChange" v-model="czData.gateway">
                                                <el-option v-for="item in gatewayList" :key="item.id"
                                                    :label="item.title" :value="item.name"></el-option>
                                            </el-select>
                                        </el-form-item>
