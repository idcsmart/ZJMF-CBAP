const lang_obj = {
  ...
  deleteOrderTip2: "若刪除產品，將不會執行模塊刪除任務，可能會導致產品失控，請謹慎操作",
  sign_pay: "標記支付",
  order_amount: "訂單金額",
  balance_paid: "可支付餘額",
  active_num: "已開通數量",
  ...
  order_text55: "工單狀態",
  order_text56: "工單完結狀態",
  order_text57: " 待接單、用戶已回复、已回复、已關閉、處理中為默認狀態，無法修改",
  ...
  disk_tip: "開啟後將在套餐配置基礎上，額外允許訂購附加數據盤，不會影響套餐內數據盤",
  ...
  sale_text36: "充值訂單提成",
  sale_text37: "大額訂單獎勵",
  sale_text38: "獎勵類型為階梯式獎勵，根據不同的範圍計算不用的費用，各個範圍對應的提成相加",
  ...
  upload_tip1: "支持批量上傳，尺寸為920px*240px,支持上傳格式包括：jpg、jpeg、png。",
  app_tip1: "不輸入時，視為無須保證金即可上傳應用",
  app_tip2: "系統默認保證金為",
  app_tip3: "在投訴內容中，自動生成一條回复記錄：您的投訴已被駁回然後將投訴狀態變為\“處理完成\”",
  ...
  box_text6: "週",
  box_text7: "已生產",
  box_text8: "購買房箱時按照設定長度為房箱設定由大寫字母和數據隨機組成的識別碼。識別碼具有唯一性",
  box_text9: "單",
  box_text10: "週",
  box_text11: "無",
  box_text12: "詳細配置",
  ...
  mf_tip30: "請注意，後續在配置週期價格時，所有周期均需填寫價格，若不填寫價格視為0",
  mf_tip31: "可直接輸入NC，視為NO_CHANGE",
  mf_tip32: "可按數量_分組id 分組輸入，示例：2_2,2_1。每組用逗號隔開，公網IP數量等於多組數量之和",
  mf_tip33: "單M價格",
  ...
  income_tip4: "該報告顯示了新客戶註冊、新訂單、續費訂單、升降級訂單的總數，並在圖表上將每一項與上一年進行了比較。",
  income_tip5: "產品收入",
  income_tip6: "此報告按商品分組顯示當前月份所有商品的收入",
  income_tip7: "該報告顯示，如果所有激活的產品都在對應週期內續費時，預計未來三年每個月的預計收入",
  ...
  contract_tip6: "開啟後，所有客戶都需簽訂本合同，如果強制簽訂打開，會影響所有產品",
  ...
  within_days: "天內",
  permanent: "永久",
  product_cashback_tip: "此處設定係統中可以購買後可返現的商品，金額將返現到賬戶餘額",
  ...
  upstream_text12: '若您尚未在該供應商註冊賬戶，請先前往供應商註冊賬戶，並開通API',
  ...
  upstream_text26: '建議在供應商處實名後再代理商品，避免供應商開啟購買實名要求後，無法購買商品。 ',
  ...
  upstream_text39: '利潤百分比必須大於0且最多保留兩位小數',
  ...
  upstream_text48: '開啟後，將同步代理商品以及可升降級商品的所有關聯可升降級的商品(可能導致代理商品過多)。利潤配置與本商品保持一致。 ',
  ...
  caravan_text5: '購買房箱時按照設定長度為房箱設定由大寫字母和數據隨機組成的識別碼。識別碼具有唯一性',
  ...
  single_product_text2: '此處設定係統中需要實名購買的商品，若實名認證插件設定「未認證無法購買」，此處未添加商品同樣無法購買',
  ...
  single_product_text17: '此處設定用戶賬戶中的某商品在設定週期內可擁有的最大數量。狀態為「已刪除」「已取消」時不計數，其他狀態均計數',
  ...
  single_product_text27: '限制週期開始時間以用戶未在限制內下的第一單時間為准開始計算',
  single_product_text28: '商品數量限制',
  single_product_text29: '此處設定用戶賬戶中的某商品的可擁有的最大數量，狀態為「已刪除」「已取消」時不計數，其他狀態均計數',
