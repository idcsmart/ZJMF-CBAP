...
const lang_obj = {
  ...
  auto_setup_tip: "After payment, the system will automatically call the interface to open to achieve automatic activation",
  basic_info: "Basic Information",
  ...
  hour: "hour",
  day: "day",
  delHostTips: "Do you need to delete the selected product? It cannot be retrieved after deletion. Deletion will not execute module actions",
  ontrial: "trial",
  ...
  deleteOrderTip2: "If you delete the product, the module deletion task will not be performed, which may cause the product to go out of control, please operate with caution",
  sign_pay: "Sign Pay",
  ...
  upgrade_price: "Upgrade and downgrade order amount, the difference between the first two",
  ...
  retry: "Retry",
  cost_type: "Cost Type",
  free_type_tip: "After changing the fee type, the price of the configured product may be displayed abnormally. Are you sure to confirm the change?",
  ...
  currency_tip: "The single maximum recharge amount cannot be less than the single minimum recharge amount",
  ...
  tip11: "Attention! After selecting, you need to send a verification code to register, and if you don't choose, you don't need to send a verification code.",
  ...
  verify4: "The minimum amount of a single transaction must be a number greater than zero, with a maximum of two decimal places",
  ...
  order_text57: "Pending order, user has replied, replied, closed, processing is the default state and cannot be modified",
  order_text78: "Pending order, pending reply, replied, and closed are the default states, which cannot be modified",
  order_text58: "Default reply",
  order_text59: "Save default reply",
  order_text60: "You haven't saved the content you are editing, do you want to save it?",
  order_text61: "Save",
  ...
  order_text74: "Work order status name, work order status color, completion status are required!",
  ...
  resend: "Resend",
  al_tip: "Account freeze amount cannot be greater than account unfreeze amount",
  ...
  nav_text4: "This navigation has a secondary sub-navigation, please clear it and try again",
  ...
  pay_tip2: "If you choose automatic, the withdrawal application will be automatically approved",
  ...
  ssh_tip: "Customers also set a password or use an SSH key after enabling it. This function requires an SSH key plug-in. Please confirm whether the plug-in has been purchased and installed",
  disk_tip: "After opening, it will allow additional data disks to be ordered on the basis of the package configuration, and will not affect the data disks in the package",
  backup_tip: "After enabling it, you can purchase the backup function when placing an order and use it after payment",
  snap_tip: "After enabling it, you can purchase the snapshot function when placing an order and use it after payment",
  ...
  description_tip: "Support html input, used to display description when ordering",
  ...
  cloud_tip: "Please go to data center management to add a data center and create a plan",
  cloud_tip1: "After clicking, it will be automatically calculated according to the monthly price and cover the subsequent cycle price",
  cloud_tip2: "To display the data center on the order page, please go to the data center configuration page to create a data center",
  ...
  cloud_tip4: "After clicking, it will be automatically calculated according to the price of the first period and cover the price of the subsequent period",
  ...
  switch_close: "close",
  age_limit: "Age Limit",
  real_tip1: "If it is enabled, after the third-party real name is passed, it needs to be manually approved by the background",
  real_tip2: "If enabled, the name will be automatically updated to the real name after the real name is passed",
  real_tip3: "If enabled, you need to upload pictures when submitting materials",
  real_tip4: "If it is enabled, the user's registered mobile phone number will be consistent with the real-name mobile phone number before submitting authentication",
  ...
  com_tip1: "After opening, you can add or subtract the quantity of purchased goods when placing an order, the minimum is 1, and the price is a multiple of the quantity",
  ...
  com_tip3: "It can be left blank, it is used for the actual parameter value passed to the backend interface during automation",
  com_tip4: "The following fees are unit prices in the current range",
  com_tip5: "Support html, it will be displayed on the product configuration page, if not entered, it will not be displayed, you can call js to realize the custom limit and input of parameter calls",
  ...
  config_tip: "After adding, you can charge different prices according to different configurations. If you don't configure it, you will only charge the basic fee",
  custom_tip: "It is used to enter information and collect information from ordering customers, regardless of fees",
  delete_tip: "Note: After the cycle is deleted, the cycle of all configuration items will also be deleted",
  ...
  levelevl_tip: "When the discount is 5%, the user will display a 5% discount when purchasing",
  ...
  invoice_tips1: "Only upload jpg/png format files and the files cannot exceed 5Mb",
  invoice_tips2: "Please check the header that needs to be deleted!",
  invoice_tips3: "If enabled, the background will receive new invoice applications",
  invoice_tips4: "If closed, the background will no longer accept new invoice applications",
  ...
  invoice_tips7: "Tax amount: collect the customer's invoice tax, 0% is the default including tax",
  ...
  promo_tip1: "After checking, this discount code can be used in upgrading and upgrading orders",
  promo_tip2: "After checking, after using the discount code when purchasing the product, the price of the discount will be applied to the upgrade/downgrade order of the product, regardless of the restrictions on the promotion code such as the maximum number of uses and the limited period.",
  promo_tip3: "After checking, this discount code can be used in renewal orders",
  promo_tip4: "After checking, after ordering or renewing using this discount code, the subsequent renewal price will still apply the discount and ignore the restrictions of the discount code such as the maximum number of times of use and the limited period.",
  promo_tip5: "The user can only use the set cycle when purchasing",
  promo_tip6: "The discount ratio is less than or equal to 100",
  promo_tip7: "When no product is selected, the discount code is available for all products by default",
  promo_tip8: "After selecting a product, the user must have the product in the account and be activated before using the discount code. When not selecting a product, there is no requirement",
  ...
  recommend_tip1: "The referral reward can only be withdrawn after confirmation",
  recommend_tip2: "When the minimum amount can be withdrawn, the withdrawal cannot be made",
  recommend_tip3: "Set the minimum amount to trigger the referral reward when the recommended user purchases the product, calculated according to the total amount of the same product in the same order",
  recommend_tip4: "Enter 0 as immediate confirmation, the default is 14 days",
  recommend_tip5: "Enter the link of the member center page you want to recommend, one line per line.",
  ...
  sale_text38: "The reward type is a stepped reward, the unused fees are calculated according to different ranges, and the commissions corresponding to each range are added",
  ...
  sale_text125: "The automatic confirmation period of the sales commission, the unconfirmed commission will not be counted in the sales statistics",
  ...
  client_care_message4: "Please enter the title of the email or select an email template",
  ...
  client_custom_label2: "Please enter the information that can be entered in this custom user details",
  client_custom_label3: "New field",
  client_custom_label4: "Drop-down",
  client_custom_label5: "Input",
  client_custom_label6: "There may be data in the current field, are you sure to delete it?",
  ...
  voucher_tip4: "After checking, the voucher can be used in upgrade and upgrade orders",
  voucher_tip5: "After checking, the voucher can be used in the renewal order",
  voucher_tip6: "After selecting a product, the following products must be included in the order to use the voucher. When no product is selected, there is no requirement",
  voucher_tip7: "After selecting a product, the user account must have the product and be activated before using the voucher. If no product is selected, there is no requirement",
  voucher_tip8: "All users in the system have been selected",
  voucher_tip9: "If the number of vouchers is insufficient, they will be issued to system users sequentially, while stocks last",
  ...
  upload_tip: "Batch upload is supported, and the upload format is jpg, jpeg, png",
  upload_tip1: "Batch upload is supported, the size is 920px*240px, and upload formats include: jpg, jpeg, png.",
  app_tip1: "If you don't enter it, you can upload the app without deposit",
  app_tip2: "The system default margin is",
  app_tip3: "In the complaint content, a reply record is automatically generated: your complaint has been rejected and the complaint status will be changed to \"processing completed\"",
  app_tip4: "Please enter the search ID, user name, email, mobile phone number, product name",
  ...
  j_tip2: "If the business fails to submit new follow-up records after the set number of days, it will return to the high seas",
  j_tip3: "This user can see all orders",
  j_tip4: "When the business receives a new lead, it will receive a text message notification",
  j_tip5: "Whether to notify when the thread is automatically or manually retracted",
  j_tip6: "The lead has not been followed up for more than x days, and will be notified to follow up as soon as possible",
  ...
  j_tip9: "After giving up, the customer will return to the high seas and can be assigned to other business follow-ups",
  j_tip10: "After reassignment, the lead will be followed up by the newly assigned business",
  j_tip11: "15 days before the cycle renewal expires, a text message will be sent to remind you that the renewal is coming",
  ...
  box_text6: "Week",
  box_text7: "Produced",
  box_text8: "When purchasing a room box, set an identification code randomly composed of uppercase letters and data for the room box according to the set length. The identification code is unique",
  box_text9: "Single",
  box_text10: "Week",
  box_text11: "None",
  ...
  box_message5: "Please add at least one small room box expected delivery cycle data",
  box_message6: "Please add at least one medium-sized room box expected delivery cycle data",
  box_message7: "Please add at least one large room box expected delivery cycle data",
  box_message8: "The promotion date deadline should be greater than the start time",
  ...
  mf_tip6: "1. There are multiple configuration methods for memory, and the configuration method of existing data cannot be switched to other configuration methods",
  mf_tip7: "2. Stage billing and pricing rules: total price = unit price of each interval * sum of interval quantity, if there is a fault between the intervals, the fault quantity will not participate in the calculation",
  mf_tip8: "3. Total billing and pricing rules: total price = current interval price * quantity",
  mf_tip9: "Single G price",
  mf_tip10: "Note: 1. When there are multiple hard disk types in the system disk or data disk, you need to select the ordered hard disk type",
  mf_tip11: "2. When there is only one type of hard disk, the system will not display the type and select the only type by default",
  ...
  mf_tip19: "The created configuration prohibits purchase, and the pull-down data source is configured data. The range input is not limited by the configured data, and the included configurations are all restricted. Please ensure that there are still optional configurations after the restriction.",
  mf_tip20: "Only works if the disk is ordered with the product",
  mf_tip21: "Flow input 0 is regarded as unlimited flow",
  mf_tip22: "3. For windows system, the system disk capacity needs to be 27G and above, for other systems, the capacity needs to be 8G and above",
  mf_tip23: "Please enter a description within 15 characters",
  mf_tip24: "Please add public network IP price configuration",
  mf_tip25: "Please add the model specification that allows customers to choose here",
  ...
  mf_tip29: "Purchase day cycle: If you purchase on January 29, the data will be cleared on the 29th of each month. If there is no corresponding date in February, the data will be cleared on March 1, and then cleared on April 1",
  mf_tip30: "Please note that when configuring the cycle price later, all cycles need to fill in the price, if you don't fill in the price, it will be regarded as 0",
  mf_tip31: "You can directly input NC, it is regarded as NO_CHANGE",
  mf_tip32: "It can be entered in groups by quantity_group id, example: 2_2,2_1. Each group is separated by a comma, and the number of public network IPs is equal to the sum of the numbers of multiple groups",
  mf_tip33: "Single M price",
  mf_tip34: "After opening, the user can choose whether to purchase when ordering",
  /* mf_dcim */
  ...
  income_tip1: "This report also shows the data of the past 3 years, and breaks down the income by month.",
  income_tip2: "Income Report",
  income_tip3: "This report shows daily income for the current month",
  income_tip4: "This report shows the total number of new customer registrations, new orders, renewal orders, upgrade orders, and compares each to the previous year on a graph.",
  income_tip5: "Product Income",
  income_tip6: "This report shows the income of all products in the current month grouped by product",
  income_tip7: "This report shows that if all activated products are renewed within the corresponding period, the estimated monthly income for the next three years",
  ...
  contract_tip1: "The number within 20 digits will be automatically incremented by the system",
  contract_tip2: "Upload only one",
  contract_tip3: "Please enter the correct zip code",
  contract_tip4: "After the product is activated, the contract must be signed within the set time limit",
  contract_tip5: "Operation not signed after the due date",
  contract_tip6: "After opening, all customers need to sign this contract. If it is forced to open, it will affect all products",
  ...
  permanent: "Permanent",
  product_cashback_tip: "Set here the products that can be cashed back after purchase in the system, and the amount will be cashed back to the account balance",
  ...
  credit_tip3: '*If you need multiple reminders, please use ", " to enter the number of days at intervals',
  ...
  credit_tip8: "After 8 days, the system will suspend products purchased with credit.",
  ...
  sales_plugin_text8: 'nearly three months',
  sales_plugin_text9: 'Rank of total consumption amount',
  sales_plugin_text10: 'this week',
  sales_plugin_text11: 'nearly three months',
  ...
  sales_plugin_text33: 'My customers (a)',
  ...
  upstream_text8: 'Commodity price',
  upstream_text9: 'Recommendation profile',
  upstream_text10: 'upstream account name',
  upstream_text11: 'Please enter your phone/email',
  upstream_text12: 'If you have not registered an account with the supplier, please go to the supplier to register an account and open the API',
  upstream_text13: 'Go to register',
  ...
  upstream_text21: 'Commodity description',
  ...
  upstream_text25: 'After opening, the user needs a real name to purchase',
  upstream_text26: "It is recommended to act as a proxy for the product after the supplier's real name is confirmed, so as to prevent the supplier from being unable to purchase the product after the supplier opens the purchase real-name requirement. ",
  ...
  upstream_text34: 'Recommended profile',
  ...
  upstream_text39: 'Profit percentage must be greater than 0 and retain up to two decimal places',
  ...
  upstream_text48: 'After it is enabled, all associated products that can be upgraded or downgraded will be synchronized (may lead to too many proxy products). The profit allocation is consistent with this product. ',
  ...
  upstream_text59: 'Your account registered upstream, mobile phone/email',
  ...
  sub_account_text16: 'Recommendation notification',
  ...
  sub_account_text26: 'Product Permission',
  ...
  interface_group_num: 'The number of interface groups used',
  ...
  child_interface_manage: 'Sub-interface management',
  child_tip: 'Here you can configure sub-interfaces for all common interfaces',
  ...
  child_tip3: 'The product is assigned to the interface with the least number of products first',
  child_tip4: 'Start allocation according to the interface created initially, and switch to the next interface after the quota is full',

  /* RV configuration */
  caravan_text1: 'Order list',
  caravan_text2: 'Basic configuration',
  caravan_text3: 'Agreement',
  caravan_text4: 'The length of the box identification code',
  caravan_text5: 'When purchasing a room box, set an identification code randomly composed of uppercase letters and data for the room box according to the set length. The identification code is unique',
  caravan_text6: 'First payment amount setting',
  caravan_text7: 'Estimated delivery period of small room boxes',
  caravan_text8: 'single',
  caravan_text9: 'week',
  caravan_text10: 'New cycle',
  caravan_text11: 'Medium-sized room box expected delivery cycle',
  caravan_text12: 'Expected delivery period of large room boxes',
  ...
  caravan_text22: 'The balance payment has been paid',
  caravan_text23: 'Paid',
  caravan_text24: 'Date of payment',
  ...
  caravan_text32: 'Estimated delivery period',
  ...
  caravan_text44: 'Please add at least one piece of expected delivery cycle data for small room boxes',
  caravan_text45: 'Please add at least one piece of expected delivery cycle data for medium-sized housing boxes',
  caravan_text46: 'Please add at least one piece of expected delivery cycle data for large-scale housing boxes',
  ...
  caravan_text56: 'The maximum number of orders cannot be less than the minimum number of orders',
  ...
  caravan_text61: 'order has been placed',
  ...
  single_product_text2: 'This is where you set the products that require real-name purchases in the system. If the real-name authentication plug-in is set to "cannot be purchased without authentication", products that are not added here will also not be able to be purchased',
  ...
  single_product_text7: 'Are you sure to delete the real name restriction of this product?',
  single_product_text8: 'Edit Product',
  single_product_text9: 'Add new product',
  single_product_text10: 'Commodity',
  ...
  single_product_text17: 'Here set the maximum quantity of a product in the user account within the set period. When the status is "deleted" or "cancelled", it is not counted, and other statuses are counted',
  single_product_text18: 'Permanent',
  single_product_text19: 'Days',
  single_product_text20: 'Are you sure to delete the periodic restriction of this product?',
  single_product_text21: 'Editing restrictions',
  single_product_text22: 'Add restrictions',
  single_product_text23: 'Limit Quantity',
  single_product_text24: 'Limit cycle',
  single_product_text25: 'Enter 0 as a permanent limit',
  single_product_text26: 'Modifying the period will affect the period that is being restricted',
  single_product_text27: 'The limit cycle start time is calculated based on the first order time that the user does not place within the limit',
  single_product_text28: 'Product Quantity Limit',
  single_product_text29: 'Here set the maximum quantity of a product in the user account, the status is "deleted" or "cancelled" and will not be counted, other statuses will be counted',
  ...
  recommend_agent_text4: 'From',
  recommend_agent_text5: 'Edit Recommended Products',
  recommend_agent_text6: 'Add recommended product',
  recommend_agent_text7: 'Commodity Type',
  recommend_agent_text8: 'Agent Product',
  recommend_agent_text9: 'Other products',
  recommend_agent_text10: 'Owner',
  ...
  recommend_agent_text18: 'CPU (core) minimum',
  recommend_agent_text19: 'CPU (core) maximum value',
  recommend_agent_text20: 'Memory',
  recommend_agent_text21: 'Memory (GB) minimum',
  ...
  recommend_agent_text27: 'Bandwidth (Mbps) minimum',
  ...
  room_car_text28: 'Please choose whether it is an exclusive activity for car owners',
  ...
  room_car_text49: 'Please enter meals',
  ...
  stock_text41: 'reason',
  stock_text42: 'warning stock',
  stock_text43: 'After reaching the early warning stock, SMS will notify the staff',
  ...
  stock_text87: 'Status of storage',
  stock_text88: 'WeChat',
  stock_text89: 'Taobao',
  stock_text90: 'Free fish',
  stock_text91: 'other',
  stock_text92: 'order has been placed',
  stock_text93: 'has been put into storage',
  ...
  stock_text100: 'The total number of materials',
  ...
  cycle_tip1: 'After changing the generation cycle, it will be calculated from the date when the order was last generated',
