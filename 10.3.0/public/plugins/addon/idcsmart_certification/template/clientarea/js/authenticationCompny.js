    ...
    window.onload = function () {
        ...
        new Vue({
            ...
            data() {
                return {
                    ...
                    enterpriseRules: {
                        ...
                        card_name: [
                            { required: true, message: lang.realname_text65, trigger: 'blur' },
                        ],
                        card_type: [
                            { required: true, message: lang.realname_text66, trigger: 'blur' },
                        ],
                        card_number: [
                            { required: true, message: lang.realname_text67, trigger: 'blur' },
                        ],
                    },
                    id_card_type: [
                        {
            ...
            methods: {
                ...
                // 获取自定义字段
                getcustom_fields() {
                    custom_fields({ name: this.plugin_name, type: 'company' }).then((res) => {
                ...
                getCommonData() {
                    getCommon().then(res => {
                        if (res.data.status === 200) {
                            ...
                            document.title = this.commonData.website_name + '-' + lang.realname_text75
                        }
                    })
                }
            },
