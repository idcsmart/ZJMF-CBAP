...
if (location.href.indexOf("login.htm") === -1
  && location.href.indexOf("regist.htm") === -1
  && location.href.indexOf("forget.htm") === -1
  && location.href.indexOf("goodsList.htm") === -1
  && location.href.indexOf("source.htm") === -1
  && location.href.indexOf("news_detail.htm") === -1
  && location.href.indexOf("helpTotal.htm") === -1
  && location.href.indexOf("agreement.htm") === -1
  && location.href.indexOf("goods.htm") === -1
  && location.href.indexOf("userStatus.htm") === -1
) {
    ...
    if (code) {
      switch (code) {
        ...
        case 401: // 未授权:2个小时未操作自动退出登录
          // 几个特定页面不跳转登录页面
          if (location.href.indexOf("login.htm") === -1 && location.href.indexOf("userStatus.htm") === -1 &&
            location.href.indexOf("goodsList.htm") === -1 && location.href.indexOf("source.htm") === -1 &&
            location.href.indexOf("news_detail.htm") === -1 && location.href.indexOf("helpTotal.htm") === -1
            && location.href.indexOf("goods.htm") === -1) {
