...
class ThisYearSale extends Widget
{
    ...
    public function output(){
    	...
    	return <<<HTML
<div class="top-item increase-bg"><div class="item-nums"><span class="num">{$data['this_year_amount']}</span> <span class="trend up-green-text">同比 ↑ {$data['this_year_amount_percent']}%</span></div> <div class="item-title">本年销售额{$currencySuffix}</div></div>
HTML;
    }
