(function () {
  ...
  const module_lang = {
    "zh-cn": {
      ...
      mf_tip17: "数据中心与计算限制",
      mf_tip18: "带宽与计算限制",
      mf_tip19: "注意：用户订购时，若命中规则中的某一配置项，则系统将根据限制规则展示配置",
      ...
      mf_choose_tip: "勾选需要限制的配置项。单次限制配置项，至少两个。选择配置项后，配置对应规则",
    },
    "zh-hk": {
      add: "添加",
      add_cycle: "添加周期",
      ...
      mf_tip17: "數據中心與計算限制",
      mf_tip18: "帶寬與計算限制",
      mf_tip19: "註意：用戶訂購時，若命中規則中的某壹配置項，則系統將根據限制規則展示配置",
      ...
      mf_choose_tip: "勾選需要限制的配置項。單次限制配置項，至少兩個。選擇配置項後，配置對應規則",
    },
    "en-us": {
      add: "Add",
      add_cycle: "Add cycle",
      ...
      mf_tip19: "Note: When users place an order, if a configuration item in the rule is hit, the system will display the configuration according to the restriction rule",
      ...
      mf_tip41: "After input NC, you can enter the number of IPs used for front-end display.",
      mf_tip42: "After input NC, you can enter the bandwidth for front-end display.",
      ...
      mf_choose_tip: "Check the configuration items that need to be restricted. At least two configuration items should be restricted at a time. After selecting the configuration items, configure the corresponding rules.",
    },
  };
