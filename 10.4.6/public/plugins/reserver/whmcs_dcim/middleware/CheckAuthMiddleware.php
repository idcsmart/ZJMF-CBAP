<?php
namespace reserver\whmcs_dcim\middleware;
 ...
 * @title hook验证
 * @desc hook验证
 * @use reserver\whmcs_dcim\middleware\CheckAuthMiddleware
 */
class CheckAuthMiddleware
{
    ...
    public function checkAuth(Request $request){
        ...
        if(isset($auth[$action])){
            ...
            if(!$res){
                return ['status'=>400, 'msg'=>lang_plugins('res_whmcs_dcim_no_auth')];
            }
        }
        return ['status'=>200];
    }
