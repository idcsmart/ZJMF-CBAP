<?php
namespace reserver\mf_finance_dcim\validate;
...
class HostValidate extends Validate{
	...
	protected $message  =   [
		'id.require' 		=> 'res_mf_finance_dcim_id_error',
		'id.integer' 		=> 'res_mf_finance_dcim_id_error',
		'id.checkAuth' 		=> 'res_mf_finance_dcim_host_not_found',
		'id.array'         	=> 'res_mf_finance_dcim_id_error',
        'action.require'	=> 'res_mf_finance_dcim_param_error',
        'action.in'       	=> 'res_mf_finance_dcim_param_error',
	];
