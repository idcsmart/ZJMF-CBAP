...
function restoreSnapshot(params) {
  return Axios.post(
    `/remf_finance_common/${params.id}/snapshot/restore`,
    params
  );
}
...
function backupConfig(params) {
  return Axios.get(`/remf_finance_common/${params.id}/backup_config`, {
    params,
  });
}
...
function backupOrder(params) {
  return Axios.post(
    `/remf_finance_common/${params.id}/backup_config/order`,
    params
  );
}
...
function delSnapshot(params) {
  return Axios.delete(
    `/remf_finance_common/${params.id}/snapshot/${params.snapshot_id}`,
    params
  );
}
// 备份列表
...
function delBackup(params) {
  return Axios.delete(
    `/remf_finance_common/${params.id}/backup/${params.backup_id}`,
    params
  );
}
...
function config(params) {
  return Axios.get(`/product/${params.product_id}/remf_finance_common/config`, {
    params,
  });
}
// 获取购买磁盘价格
...
function diskExpanOrder(params) {
  return Axios.post(
    `/remf_finance_common/${params.id}/disk/resize/order`,
    params
  );
}
...
function image(params) {
  return Axios.get(`/product/${params.id}/remf_finance_common/image`, {
    params,
  });
}
// 检查产品是否购买过镜像
...
function upgradePackage(params) {
  return Axios.get(
    `/product/${params.product_id}/remf_finance_common/package`,
    { params }
  );
}
// 获取升降级套餐价格
function upgradePackagePrice(params) {
  return Axios.get(`/remf_finance_common/${params.id}/common_config`, {
    params,
  });
}
// 生成升降级套餐订单 type : upgrade_config upgrade_product
function upgradeOrder(type, params) {
  return Axios.post(`/remf_finance_common/${params.id}/${type}`, params);
}
// 获取是否救援系统
...
function chartList(params) {
  return Axios.post(`/remf_finance_common/${params.id}/chart`, params);
}
...
function unmount(params) {
  return Axios.post(
    `/remf_finance_common/${params.id}/disk/${params.disk_id}/unmount`,
    params
  );
}
...
function mount(params) {
  return Axios.post(
    `/remf_finance_common/${params.id}/disk/${params.disk_id}/mount`,
    params
  );
}
...
function getOrderConfig(params) {
  return Axios.get(`/product/${params.id}/remf_finance_common/order_page`, {
    params,
  });
}
// 获取线路配置
function getLineConfig(params) {
  return Axios.get(
    `/product/${params.id}/remf_finance_common/line/${params.line_id}`,
    { params }
  );
}
// 获取附加IP价格
...
function changeVpc(params) {
  return Axios.put(`/remf_finance_common/${params.id}/vpc_network`, params, {
    timeout: 1000 * 60 * 10,
  });
}
...
function delVpc(params) {
  return Axios.delete(
    `/remf_finance_common/${params.id}/vpc_network/${params.vpc_network_id}`
  );
}
//创建VPC网络
...
function upgradePrice(id, params) {
  return Axios.post(
    `/remf_finance_common/host/${id}/remf_finance_common`,
    params
  );
}
// 修改配置重新计算周期价格
function calculate(params) {
  return Axios.post(
    `/remf_finance_common/product/${params.id}/configoption/calculate`,
    params
  );
}
//产品配置升降级异步获取升降级价格
function syncUpgradePrice(id, params) {
  return Axios.post(
    `/remf_finance_common/host/${id}/sync_upgrade_config_price`,
    params
  );
}
// 产品升降级
function upgradeHost(params) {
  return Axios.post(
    `/remf_finance_common/${params.id}/checkout_upgrade_product`
  );
}
//产品配置升降级
function upgradeConfigHost(host_id, params) {
  return Axios.post(
    `/remf_finance_common/host/${host_id}/upgrade_config`,
    params
  );
}
...
function saveUpgradeHost(params) {
  return Axios.post(
    `/remf_finance_common/${params.id}/sync_upgrade_product_price`,
    params
  );
}
...
function saveUpgradeCnfig(params) {
  return Axios.post(
    `/remf_finance_common/${params.id}/sync_upgrade_config_price`,
    params
  );
}
...
function provision(params) {
  return Axios.post(`/remf_finance_common/${params.id}/${params.func}`, params);
}

// 前台产品内页自定义页面输出
function configArea(params) {
  return Axios.get(`/remf_finance_common/${params.id}/custom/content`, {
    params,
  });
}
