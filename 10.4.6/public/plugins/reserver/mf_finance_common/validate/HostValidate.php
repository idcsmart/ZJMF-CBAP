<?php
namespace reserver\mf_finance_common\validate;
...
class HostValidate extends Validate{
	...
	protected $message  =   [
		'id.require' 		=> 'res_mf_finance_common_id_error',
		'id.integer' 		=> 'res_mf_finance_common_id_error',
		'id.checkAuth' 		=> 'res_mf_finance_common_host_not_found',
		'id.array'         	=> 'res_mf_finance_common_id_error',
        'action.require'	=> 'res_mf_finance_common_param_error',
        'action.in'       	=> 'res_mf_finance_common_param_error',
	];
