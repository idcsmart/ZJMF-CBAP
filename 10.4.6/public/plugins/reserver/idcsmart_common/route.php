...
Route::group('console/v1',function (){
    ...
    Route::post('reidcsmart_common/host/:host_id/provision/status', "\\reserver\\idcsmart_common\\controller\\home\\CloudController@provisionFuncStatus");
    Route::post('reidcsmart_common/host/:host_id/provision/:func', "\\reserver\\idcsmart_common\\controller\\home\\CloudController@provisionFunc")->middleware(\app\http\middleware\CheckClientOperatePassword::class);
