...
Route::group('console/v1',function (){
    ...
    Route::post('idcsmart_common/host/:host_id/provision/status', "\\server\\idcsmart_common\\controller\\home\\IdcsmartCommonProductController@provisionFuncStatus");
    Route::post('idcsmart_common/host/:host_id/provision/:func', "\\server\\idcsmart_common\\controller\\home\\IdcsmartCommonProductController@provisionFunc")->middleware(\app\http\middleware\CheckClientOperatePassword::class);
    ...
    Route::get('idcsmart_common/:id/log', "\\server\\idcsmart_common\\controller\\home\\IdcsmartCommonProductController@log");
})->allowCrossDomain([
    'Access-Control-Allow-Origin'        => $origin,
    'Access-Control-Allow-Credentials'   => 'true',
    'Access-Control-Max-Age'             => 600,
...
Route::group(DIR_ADMIN . '/v1',function (){
    ...
    Route::post('idcsmart_common/product/:product_id/configoption/order', "\\server\\idcsmart_common\\controller\\admin\\IdcsmartCommonProductConfigoptionController@configoptionOrder");
    ...
    Route::post('idcsmart_common/configoption/:configoption_id/sub/order', "\\server\\idcsmart_common\\controller\\admin\\IdcsmartCommonProductConfigoptionSubController@subOrder");
