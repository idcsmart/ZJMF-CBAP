(function () {
  const module_lang = {
    "zh-cn": {
      ...
      simulate_physical_tip: "开启此功能后，将对操作系统隐藏部分虚拟机标识。可用于部分需要在物理机中才能运行的软件，比如显卡直通后安装显卡驱动，部分显卡在虚拟机下无法安装驱动。(该功能并非对所有软件都能生效)",
    },
    "en-us": {
      ...
      cur_ipv6_tip: "Please select the total number of additional IPv6 you require",
    ...
    "zh-hk": {
      ...
      simulate_physical_tip: "開啟此功能後，將對操作系統隱藏部分虛擬機標識。可用於部分需要在物理機中才能運行的軟件，比如顯卡直通後安裝顯卡驅動，部分顯卡在虛擬機下無法安裝驅動。(該功能並非對所有軟件都能生效)",
    },
  };
