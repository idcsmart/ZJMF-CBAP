...
class CloudValidate extends Validate
{
	protected $rule = [
        ...
        'simulate_physical_machine' => 'require|in:0,1',
    ...
    protected $message  =   [
        ...
        'simulate_physical_machine.require' => 'mf_cloud_simulate_physical_machine_param_error',
        'simulate_physical_machine.in'      => 'mf_cloud_simulate_physical_machine_param_error',
        'id.array'                          => 'id_error',
        'action.require'                    => 'param_error',
        'action.in'                         => 'param_error',
        'ipv6_num.integer'                  => 'ipv6_num_format_error',
        'ipv6_num.between'                  => 'ipv6_num_format_error',
    ];
    ...
    protected $scene = [
        ...
        'upgrade_ip_num'            => ['id','ip_num','ipv6_num'],
        'unmount_disk'              => ['id','disk_id'],
        'mount_disk'                => ['id','disk_id'],
        'snapshot'                  => ['id','snapshot_id'],
        'backup'                    => ['id','backup_id'],
        'create_snapshot'           => ['id','disk_id','name'],
        'simulate_physical_machine' => ['id','simulate_physical_machine'],
    ];
