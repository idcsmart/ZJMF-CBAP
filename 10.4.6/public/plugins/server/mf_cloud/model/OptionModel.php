...
class OptionModel extends Model
{
    ...
    public function optionCreate($param)
    {
        if(in_array($param['rel_type'], [OptionModel::CPU,OptionModel::MEMORY,OptionModel::SYSTEM_DISK,OptionModel::DATA_DISK])){
            ...
            $param['rel_id'] = 0;
        }else if(in_array($param['rel_type'], [OptionModel::LINE_BW,OptionModel::LINE_FLOW,OptionModel::LINE_DEFENCE,OptionModel::LINE_IP,OptionModel::LINE_GPU,OptionModel::LINE_IPV6])){
