...
class ImageModel extends Model
{
    ...
    public function imageCreate($param)
    {
        ...
        $description = lang_plugins('log_mf_cloud_add_image_success', ['{name}'=>$param['name']]);
    ...
    public function imageUpdate($param)
    {
        ...
        if(!empty($description)){
            $description = lang_plugins('log_mf_cloud_modify_image_success', ['{detail}'=>$description]);
    ...
    public function imageDelete($id)
    {
        ...
        $description = lang_plugins('log_mf_cloud_delete_image_success', ['{name}'=>$image['name']]);
        active_log($description, 'product', $image['product_id']);
    ...
    public function checkHostImage($param)
    {
        ...
        if(isset($param['check_limit_rule']) && $param['check_limit_rule'] == 1){
            ...
            $checkLimitRule = $LimitRuleModel->checkLimitRule($productId, $currentConfig);
    ...
    public function imageBatchDelete($id)
    {
        ...
        $description = lang_plugins('log_mf_cloud_delete_image_success', ['{name}'=>$imageName]);
