...
return [
    ...
    'mf_dcim_limit_rule_not_found'=>'The restriction rule does not exist',
    ...
    'mf_dcim_limit_rule_eq'=>'equal to',
    'mf_dcim_limit_rule_neq'=>'Not equal to',
	...
	'mf_dcim_value_show_length_error'=>'The custom display cannot exceed 255 characters',
    'mf_dcim_limit_rule_select_data_center'=>'Please select a data center',
    'mf_dcim_limit_rule_select_image'=>'Please select the operating system',
    'mf_dcim_limit_rule_select_model_config'=>'Please select model configuration',
    ...
    'mf_dcim_limit_rule_range_min_and_max_at_least_one'=>'Enter at least one minimum value and maximum value',
    'mf_dcim_limit_rule_range_min_format_error'=>'The minimum value can only be entered as an integer from 0-99999999',
    'mf_dcim_limit_rule_range_max_format_error'=>'The maximum value can only be entered as an integer from 0-99999999',
    'mf_dcim_limit_rule_range_min_cannot_gt_max'=>'The minimum value cannot be greater than the maximum value',
    'mf_dcim_limit_rule_cannot_add_bw_and_flow_in_one_rule'=>'The same rule cannot add bandwidth and traffic simultaneously',
    'mf_dcim_limit_rule_rule_require'=>'Please select the conditions',
    'mf_dcim_limit_rule_result_require'=>'Please select the result',
    'mf_dcim_limit_rule_opt_error'=>'Operators can only select equal/not equal',
    ...
    'mf_dcim_limit_rule_and_result_type_must_diff'=>'The condition/result cannot be set with the same option',
	...
	'mf_dcim_log_limit_rule_create_success'=>'Adding restriction rules successfully, product: {name}, rule: {rule}',
	'mf_dcim_log_limit_rule_update_success'=>'Modification of restriction rules was successful, product: {name}, rule changed from {old} to {new}',
	'mf_dcim_log_limit_rule_delete_success'=>'Restriction rule deleted successfully, product: {name}, rule: {rule}',
