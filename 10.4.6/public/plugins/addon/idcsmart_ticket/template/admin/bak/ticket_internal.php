...
<div id="content" class="template" v-cloak>
  <t-card class="list-card-container">
    ...
    <div class="order-search-wrapper internal">
      ...
      <t-input v-model="params.keywords" :placeholder="lang.please_search_order" clearable @keypress.enter.native="doInternalOrderSearch" @clear="doInternalOrderClear">
    ...
    <t-pagination show-jumper v-if="total" :total="total" :page-size="params.limit" :current="params.page" :page-size-options="pageSizeOptions" @change="changePage" />
  </t-card>
