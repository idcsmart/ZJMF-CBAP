  ...
  methods: {
    ...
    initTemplate() {
      ...
      tinymce.init({
        ...
        width: "100%",
        plugins:
          "link lists  code table colorpicker textcolor wordcount contextmenu fullpage paste fullscreen",
        toolbar:
          "bold italic underline strikethrough | fontsizeselect | forecolor backcolor | alignleft aligncenter alignright alignjustify | bullist numlist | outdent indent blockquote | undo redo | link unlink image fullpage code | removeformat | fullscreen",
