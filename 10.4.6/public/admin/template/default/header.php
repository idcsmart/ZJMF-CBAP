              ...
              <div class="search-box">
                ...
                <div class="item bot" id="search-key">
                  <div class="left">
                    ...
                    <t-date-picker v-else-if="curSearchType === 'date'" v-model="globalForm.value"
                      :popup-props="{ attach: '#search-key' }"></t-date-picker>
                    <t-input v-else :placeholder="lang.input" v-model="globalForm.value" @keypress.enter.native="handleGlobal"></t-input>
                  </div>
