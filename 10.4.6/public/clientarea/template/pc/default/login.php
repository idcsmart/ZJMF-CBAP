    ...
    <div id="login" v-cloak>
      <div class="login-container">
        ...
        <div class="container-before">
          <div class="login">
            <div class="lang-box" v-if="commonData.lang_list.length !== 0 && commonData.lang_home_open == 1">
              <el-select style="width: 1.3rem;" v-model="seletcLang" @change="changeLang"
                :disabled="commonData.lang_home_open == 0">
            ...
            <div class="login-form">
              ...
              <div class="form-main">
                ...
                <div class="form-item">
                  <el-button type="primary" :loading="loginLoading" class="login-btn"
                    @click="doLogin">{{ lang.login }}</el-button>
      ...
      <safe-confirm ref="safeRef" :is-login="true" :password.sync="client_operate_password"
        @confirm="hadelSafeConfirm"></safe-confirm>
      <!-- 验证码 -->
