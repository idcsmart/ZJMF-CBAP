...
class PublicController extends BaseController
{
    ...
    public function loginInfo()
    {
        $result = [
            ...
            'data' => [
                ...
                'lang_admin' => configuration('lang_admin')
            ]
        ];
    ...
    {
        $url = 'http://api.xinnet.com/domain/api.gb?method=queryTemplate';
        $param = http_build_query(['testFlag' => '新网数码', 'tname'=>'lichangquan', 'refresh' => 'true', 'charset' => 'utf-8', 'client' => 'agent382485', 'type' => 'ALL', 'checksum' => md5('queryTemplatelichangquanagent382485Jytx888777')]);
        $url = $url.'&'.$param;
        $res = curl($url, [], 30, 'POST');
        var_dump($res);die;
    }
}