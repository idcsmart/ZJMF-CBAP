const lang_obj = {
  ...
  mf_ratio_tip4: "If the renewal period is changed, the price of the new cycle will be automatically converted according to the cycle ratio",
  ...
  mf_package_tip9: "Please ensure that the system disk capacity/number of Gpus in the upgrade/downgrade package is consistent ",
  ...
  mf_tip6:
    "1. There are multiple configuration methods for memory, and the configuration method of existing data cannot be switched to another",
  mf_tip7:
  ...
  mf_p5: "The commodity will not be opened through the interface after opening the commodity, the administrator needs to manually allocate resources ",
  mf_p6: "Please add a model specification here that allows customers to change the configuration ",
  mf_p7: "Do not fill in or fill in 0 as unlimited ",
  mf_p8: "The price here is the recommended configuration price, including bandwidth and IP",
  mf_p9: "The price of the optional content is calculated according to the hardware price in the hardware configuration ",
  mf_p10:
  ...
  mf_p11: "Recommended and optional configurations of memory and hard disk combined must not exceed the set maximum value ",
  ...
  mf_p15: "If it is turned on, the machine with the optional hardware ordered by the user will also be turned on automatically ",
  mf_p16: "The price here does not include the option, the option content price is calculated according to the hardware price in the hardware configuration ",
  mf_p17: "The total of optional memory and hard disk cannot exceed the set maximum value ",
  mf_p18: "Value-added Option ",
  mf_p19: "Whether value-added options are allowed ",
  mf_p20: "After opening, the user can perform value-added selection at the front desk ",
  ...
  mf_p27: "When enabling the value-added option, go to ' Hardware Configuration ' to set the corresponding option parameters ",
  mf_p28: "The remaining memory capacity is an optional value, equal to the maximum memory capacity supported by the model minus the default value on the left ",
  ...
  da_tip8: "Information modification here only changes the front desk display, the actual change please go to DA control, change the package information will change other parameter information ",
  ...
  bt_tip1: "Requires XFS file system and includes prjquota mount parameter to use ",
  bt_tip2: "The pagoda does not support setting traffic limits for the time being, 8.0.4 will be supported (currently it is only used for foreground display) ",
  bt_tip3: "If no host is specified, the user will be automatically assigned to one of the associated hosts when purchasing ",
  bt_tip4: "Periodic scaling ",
  bt_tip5: "After opening, the price of other renewal cycles of the product will be directly converted according to the ratio of the current renewal cycle to the other cycles ",
