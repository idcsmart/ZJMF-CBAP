const lang_obj = {
  ...
  cur_cycle_tip: '若產品續費切換週期，不使用周期比例進行價格換算,則係統將以切換週期的原價進行計算,切換週期的原價由當前週期原價按比例計算的來,因此當續費不使用周期比例時 ，修改原價將對新周期的續費價格產生影響',
  financial: "財務",
  auto_order: "工單",
  ...
  da_tip6: "默認為1，0為不限制",
  da_tip7: "請先配置主機",
  da_tip8: "此處信息修改僅變更前臺展示，實際變動請前往 DA 控制，變更套餐信息會同時變更其他參數信息",
  ...
  bt_tip4: "按周期比例換算",
  bt_tip5: "開啟後，該產品其他續費周期的價格將按照當前續費周期與其他周期的比例進行直接換算",
