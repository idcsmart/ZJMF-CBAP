        ...
        new Vue({
            data() {
                return {
                    ...
                    productRules: {
                        username: [{ required: true, message: lang.input + lang.upstream_text10, type: 'error' }],
                        token: [{ required: true, message: lang.input + lang.upstream_text14, type: 'error' }],
                        secret: [{ required: true, message: lang.input + lang.upstream_text16, type: 'error' }],
                        name: [{ required: true, message: lang.input + lang.upstream_text28, type: 'error' }],
                        profit_percent: [
                            { required: true, message: lang.input + lang.upstream_text18, type: 'error' },
                            {
                                pattern: /^([1-9]\d*(\.\d{1,2})?|([0](\.([0][1-9]|[1-9]\d{0,1}))))$/,
                                message: lang.upstream_text39, type: 'error'
                            }
                        ],
