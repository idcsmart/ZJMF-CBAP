            ...
            <div class="login">
              ...
              <div class="login-form">
                ...
                <div class="form-main">
                  ...
                  <div class="form-item rember-item">
                    ...
                    <span>
                      <template v-if="commonData.login_phone_verify == 1">
                        <span
                          class="a-text"
                          v-if="isPassOrCode && commonData.login_phone_verify !=0"
                          @click="isPassOrCode = false;isEmailOrPhone = false"
                          >{{ lang.login_code_login }}</span
                        >
                        <span
                          v-else
                          class="a-text"
                          @click="isPassOrCode =true"
                          >{{ lang.login_pass_login }}</span
                        >
                      </template>
                  ...
                  <template
                    v-if="commonData.oauth && commonData.oauth?.length > 0"
                  >
                    ...
                    <div class="form-item login-type">
                      <div
                        class="oauth-item"
                        v-for="(item,index) in commonData.oauth"
                        :key="index"
