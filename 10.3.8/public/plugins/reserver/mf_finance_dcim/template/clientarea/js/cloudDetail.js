      ...
      try {
        ...
        if (this.lineDetail.ip) {
          if (this.cloudData?.ip_num !== 0) { // 初次回填
            ...
            this.params.ip_num = this.lineDetail.ip[0]?.value || this.cloudData.ip_num * 1
          }
    ...
    getCloudDetail() {
      ...
      cloudDetail(params).then(res => {
        if (res.data.status === 200) {
          ...
          this.osIcon = "/plugins/reserver/mf_finance_dcim/template/clientarea/img/remf_finance_dcim/" + this.osData[0]?.name + '.svg'
    ...
    getImage() {
      ...
      image(params).then(res => {
        if (res.data.status === 200) {
          ...
          this.reinstallData.osGroupId = this.osData[0].id
          this.osIcon = "/plugins/reserver/rewhmcs_dcim/view/img/" + this.osData[0].name + '.png'
    ...
    osSelectGroupChange(e) {
      this.osData.map(item => {
        if (item.id == e) {
          ...
          this.osIcon = "/plugins/reserver/mf_finance_dcim/template/clientarea/img/remf_finance_dcim/" + item.name + '.svg'
          this.reinstallData.osId = this.osSelectData[0]?.id
          // this.doCheckImage()
        }
      })
