...
class ModelConfigValidate extends Validate{
    ...
    protected $scene = [
        'create' => ['product_id','name','group_id','cpu','cpu_param','memory','disk','price','support_optional','optional_memory_id','leave_memory','max_memory_num','optional_disk_id','max_disk_num','gpu','optional_gpu_id','max_gpu_num'],
        'update' => ['id','name','group_id','cpu','cpu_param','memory','disk','price','support_optional','optional_memory_id','leave_memory','max_memory_num','optional_disk_id','max_disk_num','gpu','optional_gpu_id','max_gpu_num'],
