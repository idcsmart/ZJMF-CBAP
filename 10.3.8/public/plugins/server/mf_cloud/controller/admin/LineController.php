...
class LineController{
     ...
     * @return  int gpu_enable - 启用GPU价格配置(0=关闭,1=开启)
     * @return  int gpu_name - GPU型号
     * @return  int order - 排序
     ...
     * @return  string gpu_data[].value - GPU数量
     ...
     * @param  	string other_config.traffic_type - 计费方向(1=进,2=出,3=进+出) require
