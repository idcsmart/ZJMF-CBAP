const cloudTop = {
            ...
            <div class="msg-l">
                <div class="system-t">
                    ...
                    <div class="btn-port">
                        ...
                        <div class="port">默认端口:{{rescueData.port}}</div>
                    </div>
                    ...
                    <div class="user-name-pass">
                        ...
                        <div class="user-pass">密码：
                            ...
                            <img class="eyes" :src="isShowPass?'${url}img/cloud/pass-show.png':'${url}img/cloud/pass-hide.png'" @click="isShowPass=!isShowPass" />
                        </div>
                    </div>
    ...
    <el-tabs class="tabs" v-model="activeName" @tab-click="handleClick">
        <el-tab-pane label="统计图表" name="1"></el-tab-pane>
    ...
    methods: {
        ...
        handleClick() {
            switch (this.activeName) {
                case '1':
                    location.href = `cloudCharts.htm?id=${this.id}`
                    break;
                case '2':
                    location.href = `cloudManager.htm?id=${this.id}`
                    break;
                case '3':
                    location.href = `cloudDisk.htm?id=${this.id}`
                    break;
                case '4':
                    location.href = `cloudNet.htm?id=${this.id}`
                    break;
                case '5':
                    location.href = `cloudBackupSnapshot.htm?id=${this.id}`
                    break;
                case '6':
                    location.href = `cloudLog.htm?id=${this.id}`
                    break;
            }
        },
        // 获取通用配置
