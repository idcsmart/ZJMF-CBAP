...
<div id="content" class="real_name_approval table" v-cloak>
  <t-card class="list-card-container">
    ...
    <div class="common-header">
      ...
      <div class="r-box">
        <div class="com-search">
          <t-input v-model="params.keywords" class="search-input" :placeholder="`${lang.proposer}`" @keyup.enter.native="seacrh" :on-clear="clearKey" clearable>
          </t-input>
    ...
    <t-pagination show-jumper :total="total" :page-size="params.limit" :page-size-options="pageSizeOptions" :on-change="changePage" :current="params.page" v-if="total" />
  </t-card>
  <!-- 通过/驳回-->
