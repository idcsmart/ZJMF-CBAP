(function () {
  const plugin_lang = {
    "zh-cn": {
      ...
      sure_del_backup: "是的，删除备份",
      sure_del_snap: "是的，删除快照",
    ...
    "en-us": {
      ...
      mf_val2:
        "Only special symbols in ~!@#$&* ()_ -+=| {}[];:<>?,./ can be entered",
      ...
      common_cloud_tip33:
        "1. The length is 6 characters or more. 2. Only uppercase letters, lowercase letters, numbers, ~!@#$&* ()_ -+=| {}[];:<>?,./ can be entered. Symbol 3. It cannot start with / 4. It must contain lowercase letters a~z, uppercase letters A~Z, letters 0-9",
      ...
      common_cloud_tip43: "Friendly reminder!",
      common_cloud_tip29:
      ...
      sure_del_backup: "Yes, delete backup",
      sure_del_snap: "Yes, delete snapshot",
      ...
      mf_tip29: "Only 16 disks can be configured at most",
      ...
      common_cloud_text76: "Enter bandwidth",
    ...
    "zh-hk": {
      ...
      sure_del_backup: "是的，刪除備份",
      sure_del_snap: "是的，刪除快照",
