...
function saveUpgradeHost(params) {
  return Axios.post(`/remf_finance_common/${params.id}/sync_upgrade_product_price`, params);
}

// 升级配置提交配置
function saveUpgradeCnfig(params) {
  return Axios.post(`/remf_finance_common/${params.id}/sync_upgrade_config_price`, params);
}
