  ...
  <com-config>
    <t-card class="list-card-container">
      <ul class="common-tab">
        ...
        <li v-if="$checkPermission('auth_system_configuration_system_configuration_web_configuration') && !hasController">
        ...
        <div class="upgrade-contend">
          <div class="msg-item">
            <div class="s-item">
              ...
              <div class="msg-footer" v-if="hasUpdate && $checkPermission('auth_system_configuration_system_configuration_system_info_system_upgrade')">
            ...
            <div class="s-item">
              ...
              <t-button class="auth-btn" @click="handlerChange" v-permission="'auth_system_configuration_system_configuration_system_info_change_license'">{{lang.upload_text10}}</t-button>
              <t-button class="auth-btn" :loading="updateCode" @click="handlerUpdate" v-permission="'auth_system_configuration_system_configuration_system_info_update_license'">{{lang.upload_text11}}</t-button>
            </div>
          </div>
