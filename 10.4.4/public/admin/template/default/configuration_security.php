    ...
    <div class="box">
      <t-form :data="formData" :label-width="80" label-align="top" :rules="rules" ref="formValidatorStatus" @submit="onSubmit">
        ...
        <t-form-item class="submit">
          <t-button theme="primary" type="submit" style="margin-right: 10px" :loading="submitLoading" v-permission="'auth_system_configuration_captcha_configuration_captcha_configuration_save_configuration'">{{lang.hold}}</t-button>
        </t-form-item>
      </t-form>
    </div>
  </t-card>
