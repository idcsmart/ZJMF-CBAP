  ...
  <com-config>
    <t-card class="list-card-container b-table">
      <div class="common-header">
        <div class="btn-box">
          <t-button @click="addGroup" v-permission="'auth_upstream_downstream_upstream_product_create_group'">{{lang.upstream_text43}}</t-button>
          <t-button theme="default" class="add-btn" @click="addProduct" v-permission="'auth_upstream_downstream_upstream_product_create_upstream_product'">{{lang.add_other_product}}</t-button>
        </div>
    ...
    <!-- 编辑商品 -->
    <t-dialog :header="isEdit ? lang.edit_goods : lang.add_other_product"
    :width="isEn ? 600 : 480"
    :visible.sync="productModel" :footer="false" @close="closeProduct" class="pro-dialog">
      <t-form :data="productData" ref="productForm" @submit="submitProduct" :rules="productRules" reset-type="initial">
        <t-form-item :label="lang.upstream_text6" name="supplier_id">
          <t-select v-model="productData.supplier_id" :placeholder="lang.upstream_text6" filterable :scroll="{ type: 'virtual' }" :popup-props="{ overlayInnerStyle: { height: '200px' } }" @change="supplierChange">
        ...
        <t-form-item :label="lang.product" name="upstream_product_id">
          <t-select v-model="productData.upstream_product_id" :placeholder="lang.product" filterable :scroll="{ type: 'virtual' }" :popup-props="{ overlayInnerStyle: { height: '200px' } }">
