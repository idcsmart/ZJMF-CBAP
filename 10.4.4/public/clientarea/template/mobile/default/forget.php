...
<body>
    ...
    <div class="template">
        <div id="forget">
            <!-- 验证码 -->
            <captcha-dialog @close-dialog="isShowCaptcha = false" :is-show-captcha="isShowCaptcha"
                @get-captcha-data="getData"></captcha-dialog>
                        ...
                        <div class="login-form">
                            <div class="login-top">
                                ...
                                <div class="login-phone" :class="!isEmailOrPhone? 'active':null"
                                    @click="isEmailOrPhone = false">{{lang.login_phone}}
                                </div>
                            </div>
                            <div class="form-main">
                                <div class="form-item">
                                ...
                                <div class="form-item code-item">
                                    ...
                                    <count-down-button ref="emailCodebtn" @click.native="sendEmailCode"
                                    ...
                                    <count-down-button ref="phoneCodebtn" @click.native="sendPhoneCode"
                                        v-if="!isEmailOrPhone" my-class="code-btn"></count-down-button>
                                    <!-- <el-button v-if="!isEmailOrPhone" class="code-btn" type="primary">获取验证码</el-button> -->
