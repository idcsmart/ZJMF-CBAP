...
{
    $types = '.gif|.jpeg|.png|.bmp|.ico'; # 定义检查的图片类型
...
function idcsmart_download($file_path, $file_name)
{
    ...
    if(!empty($file)){
        ...
        return download($file_path.$file_name, $file_name);
    }
}
