...
class OauthController extends HomeBaseController
{
     ...
     * @return string jwt - jwt:注册后放在请求头Authorization里,拼接成如下格式:Bearer+空格+yJ0eX.test.ste
     */
    public function bind()
    {
        ...
        if (!$AccountValidate->scene('oauth_bind')->check($param)){
            return json(['status' => 400 , 'msg' => lang($AccountValidate->getError())]);
        }
