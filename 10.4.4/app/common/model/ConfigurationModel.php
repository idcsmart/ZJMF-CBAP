...
class ConfigurationModel extends Model
{
     ...
     * @return  int account_info_change - 账户信息变更:1是0否
    ...
    public function systemList()
    {
        ...
        foreach($configuration as $v){
            if(in_array($v['setting'], $this->config['system'])){
                if($v['setting'] == 'lang_home_open' || $v['setting'] == 'maintenance_mode' || $v['setting'] == 'client_start_id_value' || $v['setting'] == 'order_start_id_value' || $v['setting']=='home_show_deleted_host' || $v['setting']=='account_info_change'){
     ...
     * @param  int account_info_change - 账户信息变更:1是0否
    ...
    public function systemUpdate($param)
    {
        ...
        $param['account_info_change'] = intval($param['account_info_change']);
