...
class ConfigurationValidate extends Validate
{
	protected $rule = [
        ...
        'account_info_change' => 'require|in:0,1',	
    ...
    protected $message  =  [
        ...
        'account_info_change.require' => 'configuration_account_info_change_cannot_empty',
        'account_info_change.in' => 'configuration_account_info_change',
    ...
    protected $scene = [
        'system_update' => ['lang_admin','lang_home_open','lang_home','maintenance_mode','website_name','website_url','terms_service_url','terms_privacy_url','system_logo','client_start_id_value','order_start_id_value','clientarea_url','home_show_deleted_host','account_info_change'],
        'login_update' => ['register_email','register_phone','login_phone_verify','home_login_check_ip','admin_login_check_ip','code_client_phone_register','code_client_phone_register'],
