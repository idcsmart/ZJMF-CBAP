...
class ProductValidate extends Validate
{
    ...
    protected $scene = [
        'create' => ['name'],
        'edit' => ['id','name','hidden','stock_control','qty','creating_notice_sms','created_notice_sms','creating_notice_mail','description','pay_type','product_id','price'],
        'edit_server' => ['id','auto_setup','type','rel_id','show'],
