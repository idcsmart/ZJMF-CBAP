...
class SmsLogModel extends Model
{
     ...
     * @author xiong
     * @version v1
     * @param   int phone_code 86 国际区号
     * @param   string phone - 手机号
     * @param   string template_code - 模板标识
     * @param   string content - 模板内容
     * @param   int status - 发送状态(1=成功,0=失败) require
     * @param   string fail_reason - 失败原因
     * @param   int rel_id 0 关联ID
     * @param   string type client 关联类型(client=客户,admin=管理员)
     * @param   string ip 自动获取 IP
     * @param   int port 自动获取 端口号
     */
