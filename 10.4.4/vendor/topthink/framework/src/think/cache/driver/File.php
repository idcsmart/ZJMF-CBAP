...
class File extends Driver
{
    ...
    public function set($name, $value, $expire = null): bool
    {
        ...
        /*
         * 方式一
         * wyh 20240417 修改框架，经常出现权限问题：file_put_contents(/www/wwwroot/cloud.shiwaiyun.com/runtime/cache/86/5ec6fc3372d95a9bb841a8c22c6775.php): failed to open stream: Permission denied
         * */
        chmod($filename, 0755);
