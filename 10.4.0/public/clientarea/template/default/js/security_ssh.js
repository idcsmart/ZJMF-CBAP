    ...
    new Vue({
      ...
      methods: {
        ...
        getCommonData() {
          ...
          document.title = this.commonData.website_name + "-" + lang.security_tab1;
        },
        // 每页展示数改变
        sizeChange(e) {
          this.params.limit = e;
        ...
        editSub() {
          ...
          if (!data.name) {
            this.errText = lang.security_tips10;
            isPass = false;
            return false;
          }
          if (!data.public_key) {
            this.errText = lang.security_tips11;
            isPass = false;
            return false;
          }
        ...
        cjSub() {
          ...
          if (!data.public_key) {
            this.errText = lang.security_tips13;
            isPass = false;
            return false;
          }
        ...
        toLearn() {
          window.open('https://www.idcsmart.com/wiki_list/917.php', '_blank')
        }
      },
    }).$mount(template);
