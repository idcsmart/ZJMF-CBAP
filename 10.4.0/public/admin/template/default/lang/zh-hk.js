const lang_obj = {
  ...
  caravan_text5: "購買房箱時按照設定長度為房箱設定由大寫字母和數據隨機組成的識別碼。識別碼具有唯壹性",
  ...
  clientarea_url_tip: "若需要後臺與會員中心使用不同的域名請先在寶塔站點中配置多個域名然後將會員中心地址填寫在此處",
  ...
  cur_cycle_tip: "若產品續費切換周期，不使用周期比例進行價格換算,則系統將以切換周期的原價進行計算,切換周期的原價由當前周期原價按比例計算的來,因此當續費不使用周期比例時，修改原價將對新周期的續費價格產生影響",
  ...
  debug_setting_tip: "用於系統供應商檢查軟件問題，開啟後，請將以下代碼發送至軟件供應商，他們將臨時獲得管理員後臺登錄權限",
  ...
  tip9: "需重新登錄管理員後權限才生效",
  tip10: "未找到相關數據",
  tip11: "註意！選擇後，註冊時需要發送驗證碼才能註冊，不選擇則不需要發送驗證碼。",
  tip12: "天，自動暫停",
  ...
  upstream_text48: "開啟後，將同步代理商品以及可升降級商品的所有關聯可升降級的商品(可能導致代理商品過多)。利潤配置與本商品保持壹致。",
