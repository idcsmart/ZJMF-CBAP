const lang_obj = {
  display_name: "Chinese Simplified", // used to display in the language switching drop-down
   ...
   app_scene_tip1: "Official website, website, App application, store link, official account or mini program name",
   app_scene_tip2: "For applications that are not online or have unregistered domain names, you can apply for verification codes or notification templates for testing or learning source-related signatures, but there will be restrictions on sending them.",
   ...
   bt_tip5: "After turning on, the price of other renewal periods of this product will be directly converted according to the ratio of the current renewal period to other periods",
   ...
   client_custom_label11: "Drop down values, use English half Angle between values ', ' interval",
   ...
   client_custom_label25: "If the expression is wrong, the front desk may not be able to input it",
   ...
   clientarea_url_tip: "If you need to use different domain names for the backend and member center, please configure multiple domain names in the pagoda site first and then fill in the member center address here",
   clientarea_url_tip1: "The member center address and the website domain name address cannot be the same",
   ...
   debug_setting_tip: "It is used by system suppliers to check software problems. After enabling it, please send the following code to the software supplier, and they will temporarily obtain the administrator background login permission",
   ...
   deleteOrderTip2: "If you delete the product, the module deletion task will not be performed, which may cause the product to lose control. Please operate with caution",
   ...
   free: "Free",
   free_type_tip: "Changing the fee type may cause the configured product prices to display abnormally. Do you want to confirm the change?",
   ...
   hook_tip: "By default, the order is sorted by installation. Drag to adjust the serial number. The first serial number will be executed first.",
   hook_tip1: "This feature is exclusive to Enterprise/Professional users and can use official applications for free",
   ...
   host_transfer_text19: "If there is a VPC/security group/paid system image, it will be synchronized to the target user",
   hour: "hour",
   icon: "icon",
   ...
   logo_size: "size",
   logo_tip: "Recommended size: 136px * 30px, can be enlarged in the same proportion",
   logout: "Log out",
   look: "View",
   mainland: "mainland",
   ...
   nav_text15: "After turning it on, the system will first display the transfer page to remind the user whether to visit",
   ...
   scene_des_tip1: "Instructions on template usage scenarios, examples, etc. The login verification code scenario can provide login links and test accounts",
   ...
   start_price_tip: "If you do not enter it, the price will be automatically calculated according to the configuration",
   ...
   tip11: "Note! After selecting, you need to send a verification code when registering. If you do not select, you do not need to send a verification code.",
   ...
   upstream_text12: "If you have not registered an account with the supplier, please go to the supplier to register an account and activate the API",
   ...
   upstream_text26: "It is recommended to real-name the supplier before agent products, to avoid being unable to purchase goods after the supplier turns on the real-name requirement for purchase.",
   ...
   upstream_text48: "After turning on, all associated upstream and downgradeable products of agent products and upgradable and downgraded products will be synchronized (which may lead to too many agent products). The profit allocation shall be consistent with this product.",
