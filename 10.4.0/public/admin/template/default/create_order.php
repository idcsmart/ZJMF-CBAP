          ...
          <t-form :data="formData" :label-width="80" ref="userDialog" label-width="200" @submit="onSubmit" label-align="top" :rules="rules">
            ...
            <div class="new-order" v-if="formData.type==='new' && formData.client_id && formData.newProductId">
              ...
              <div class="edit-price" style="border: none;">
                ...
                <t-input-number v-if="newBuyData.custom_renew_amount_switch" v-model="newBuyData.custom_renew_amount" theme="normal" :min="0" :placeholder="lang.order_text89"></t-input-number>
              </div>
              ...
              <t-row :gutter="{ xs: 8, sm: 16, md: 24, lg: 32, xl: 32, xxl: 90 }">
                <t-col :xs="12" :xl="6">
                  <div class="item bot">
                    ...
                    <t-button type="submit" style="margin-top: 20px;" :loading="submitLoading">{{lang.submit_order}}</t-button>
                  </div>
                </t-col>
              </t-row>
            </div>
