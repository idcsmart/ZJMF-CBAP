...
<div id="content" class="navigation " v-cloak>
  <com-config>
        ...
        <t-tab-panel value="1" :label="lang.front_nav_manage" :destroy-on-hide="false">
          ...
          <div class="nav_main">
            ...
            <div class="nav_right">
              ...
              <t-button class="sure_sub" @click="subMenu" :loading="submitLoading">{{lang.apply_nav}}</t-button>
            </div>
          </div>
        </t-tab-panel>
    ...
    <!-- 新增页面弹窗 -->
    <t-dialog :visible.sync="visible" :header="lang.add_page" :footer="false"
    @close="close" class="page-dialog">
