...
class LineValidate extends Validate
{
    ...
    protected $scene = [
        'create' => ['data_center_id','name','bill_type','bw_ip_group','defence_enable','defence_ip_group','bw_data','flow_data','defence_data','ip_data','order'],
        'update' => ['id','name','bw_ip_group','defence_enable','defence_ip_group','order'],
    ];
