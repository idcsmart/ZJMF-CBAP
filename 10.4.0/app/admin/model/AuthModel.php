...
class AuthModel extends Model
{
    ...
    public function authList()
    {
        ...
        $auths = $this->order('order', 'asc')->select()->toArray();
        $ruleList = [];
     ...
     * @param string auth.parent_id - 父权限ID
     * @param string|array auth.auth_rule - 权限规则,多条传数组,单条传字符串
     * @param string|array auth.auth_rule_title - 规则描述,多条传数组,单条传字符串
