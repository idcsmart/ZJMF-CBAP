            ...
            try {
              ...
              switch (this.formData.type) {
                ...
                case 'artificial':
                  ...
                  setTimeout(() => {
                    location.href = `order_details.html?id=${res.data.data.id}`
                  }, 300)
                  break;
                // 新订单
                case 'new':
                  ...
                  setTimeout(() => {
                    location.href = `order_details.html?id=${res1.data.data.id}`
                ...
                case 'upgrade':
                  ...
                  setTimeout(() => {
                    location.href = `order_details.html?id=${res3.data.data.id}`
                  }, 300)
                  break;
              }
            } catch (error) {
