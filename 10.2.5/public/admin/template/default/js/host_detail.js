  ...
  window.onload = function () {
    ...
    new Vue({
      ...
      methods: {
        ...
        /* 跳转到订单/工单 */
        jumpToOrder () {
          location.href = str + `client_order.html?id=${this.client_id}&host_id=${this.id}`
        },
        jumpToTicket () {
          location.href = str + `plugin/idcsmart_ticket/client_ticket.html?id=${this.client_id}&host_id=${this.id}`
        },
        /* 续费 */
        renewDialog () {
          this.getRenewPage()
