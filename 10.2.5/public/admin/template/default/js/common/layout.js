    ...
    aside && new Vue({
      ...
      methods: {
        setWebTitle() {
          ...
          menu.forEach(fir => {
            ...
            if (temp.length > 0) {
              ...
              if (location.pathname.includes('client_') && !location.pathname.includes('idcsmart_client_') && !location.pathname.includes('client_care') && !location.pathname.includes('client_custom_field')) {
                ...
                menu_id = temp.filter(e => e.url === 'supplier_list.html')[0]?.id
              } else {
              ...
              temp.forEach(sec => {
                if (sec.url === url) {
                  ...
                  localStorage.lastTitle = (url === 'index.html' ? lang.home : sec.name) + '-' + website_name
                  isSetTitle = true
              ...
              if (fir.url === url) {
                document.title = (url === 'index.html' ? lang.home : fir.name) + '-' + website_name
          ...
          /* 首页 */
          if ((location.origin + '/' + location.pathname.split('/')[1] + '/index.html') === location.href) {
