    ...
    <t-card>
      ...
      <div class="info-box">
        ...
        <t-row align="middle">
          ...
          <t-col :span="6">
            <span>实名状态</span>
            <div v-if="data.certification === false">未实名<img src="/{$template_catalog}/template/{$themes}/img/icon/no_authentication.png" alt=""></div>
            <div v-else-if="data.certification && data.certification_detail && data.certification_detail.company?.status === 1">{{data.username}}({{data.certification_detail.company.company}})<img src="/{$template_catalog}/template/{$themes}/img/icon/enterprise_authentication.png" alt=""></div>
            <div v-else-if="data.certification && data.certification_detail && data.certification_detail.person?.status === 1">{{data.certification_detail.person.card_name}}<img src="/{$template_catalog}/template/{$themes}/img/icon/personal_authentication.png" alt=""></div>
          </t-col>
        </t-row>
      </div>
    </t-card>
