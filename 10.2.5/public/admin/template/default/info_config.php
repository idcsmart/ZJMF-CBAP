    ...
    <div class="box">
      <t-form :data="infoParams" @submit="submitSystemGroup" :rules="typeRules" class="info-form" label-align="top">
        ...
        <t-form-item :label="lang.web_logo" name="logo" class="web-logo">
          <t-upload :action="uploadUrl" :headers="uploadHeaders" v-model="infoParams.logo" theme="image" :placeholder="lang.upload_tip" theme="image-flow" accept="image/*" :auto-upload="true"></t-upload>
        </t-form-item>
