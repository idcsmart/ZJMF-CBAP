  ...
  <t-card class="list-card-container">
    <div class="com-h-box">
      <ul class="common-tab">
        ...
        <li>
          <a :href="`${baseUrl}/client_notice_sms.html?id=${client_id}`">{{lang.notice_log}}</a>
        </li>
        <li v-if="hasTicket && authList.includes('TicketController::ticketList')">
          <a :href="`${baseUrl}/plugin/idcsmart_ticket/client_ticket.html?id=${client_id}`">{{lang.auto_order}}</a>
        </li>
        <li>
          <a :href="`${baseUrl}/client_records.html?id=${client_id}`">{{lang.info_records}}</a>
        </li>
      </ul>
