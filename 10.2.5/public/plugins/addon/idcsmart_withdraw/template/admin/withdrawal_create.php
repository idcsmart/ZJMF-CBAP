        ...
        <t-row :gutter="{ xs: 8, sm: 16, md: 24, lg: 32, xl: 32, xxl: 60 }" class="no-label">
          <t-col :xs="12" :xl="3" :md="6">
            ...
            <t-form-item name="source" label="">
              <t-select v-model="formData.source" :placeholder="lang.withdrawal_source" :popup-props="popupProps">
          ...
          <t-col :xs="12" :xl="3" :md="6">
            ...
            <t-form-item name="method" label="">
              <t-select v-model="formData.method" :placeholder="lang.withdrawal_way" multiple :popup-props="popupProps">
        ...
        <t-row :gutter="{ xs: 8, sm: 16, md: 24, lg: 32, xl: 32, xxl: 60 }" class="no-label">
          <t-col :xs="12" :xl="3" :md="6">
            ...
            <t-form-item name="min" label="" :rules="formData.min !== '' ||  formData.max ? [
              ...
              <t-input v-model="formData.min" :placeholder="lang.min_money_limit" @change="changeMoney">
              </t-input>
        ...
        <t-row :gutter="{ xs: 8, sm: 16, md: 24, lg: 32, xl: 32, xxl: 60 }" class="no-label">
          <t-col :xs="12" :xl="3" :md="6">
            ...
            <t-form-item name="max" label="" :rules="formData.max !== '' || formData.min ?[
              ...
              <t-input v-model="formData.max" :placeholder="lang.max_money_limit">
        ...
        <t-row :gutter="{ xs: 8, sm: 16, md: 24, lg: 32, xl: 32, xxl: 60 }" class="no-label">
          <t-col :xs="12" :xl="3" :md="6">
            ...
            <t-form-item name="withdraw_fee_type" label="">
              <t-select v-model="formData.withdraw_fee_type" :placeholder="lang.withdraw_fee_type" :popup-props="popupProps">
          ...
          <template v-if="formData.withdraw_fee_type === 'fixed'">
            <t-col :xs="12" :xl="3" :md="6">
              ...
              <t-form-item name="withdraw_fee" :label="lang.cycle_sequence" class="line-text">
                <t-input v-model="formData.withdraw_fee" :placeholder="lang.max_money_limit">
                </t-input>
          ...
          <template v-else>
            <t-col :xs="12" :xl="3" :md="6">
              ...
              <t-form-item name="percent" :label="lang.cycle_sequence" class="line-text">
                <t-input v-model="formData.percent" :placeholder="lang.max_money_limit">
                </t-input>
...
<script src="/plugins/addon/idcsmart_withdraw/template/admin/js/withdrawal_create.js"></script>