        ...
        <t-row :gutter="{ xs: 8, sm: 16, md: 24, lg: 32, xl: 32, xxl: 60 }" class="no-label">
          ...
          <t-col :xs="12" :xl="3" :md="6">
            ...
            <t-form-item name="method" label="">
              <t-select v-model="formData.method" :placeholder="lang.withdrawal_way" multiple :popup-props="popupProps" :min-collapsed-num="1">
          ...
          <t-col :xs="12" :xl="3" :md="6">
            <p class="s-tit">
              ...
              <t-tooltip :content="lang.pay_tip1 + '\n' + lang.pay_tip2" :show-arrow="false" theme="light" placement="top-left" class="data-tip">
