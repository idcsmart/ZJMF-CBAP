...
<body>
          ...
          <div class="main-card">
            ...
            <div class="main-content">
              <el-form :model="certificationEnterprise" class="certification-enterprise" :rules="enterpriseRules" ref="certificationEnterprise" label-position='top' label-width="100px">
                ...
                <el-form-item label="营业执照(允许的后缀名: .jpg、.gif、.jpeg、png)" v-if="certificationInfoObj.certification_upload == 1" required>
                  ...
                  <el-upload :on-progress="onProgress" action="/console/v1/upload" accept=".jpg,.gif,.jpeg,.png" :before-upload="(file)=>onUpload(file,'img_three')" :file-list="card_three_fileList" :on-remove="handleRemove3" :limit=1 list-type="picture-card" :class="{ hide:img_three!='' }" :on-success="handleSuccess3">
                    <div slot="default" class="upload-btn-img">
                      <img src="/plugins/addon/idcsmart_certification/template/clientarea/img/account/IDcard-3.png" alt="">
                    </div>
                    <div slot="file" slot-scope="{file}">
                      <img class="el-upload-list__item-thumbnail" :src="file.url" alt="" v-if="upload_progress === '100.00%'">
                      <div class="upload-progress" v-else v-loading="upload_progress !=='100.00%'"  :element-loading-text="upload_progress"></div>
                      <span class="el-upload-list__item-actions">
                        <span class="el-upload-list__item-preview" @click="handlePictureCardPreview(file)">
                          <i class="el-icon-zoom-in"></i>
                        </span>
              ...
              <div class="next-box" >
                ...
                <el-button :loading="sunmitBtnLoading"  @click="companySumit">{{ sunmitBtnLoading ? '上传中' : '下一步'}}</el-button>
              </div>
            </div>
          </div>
  ...
  <script src="/plugins/addon/idcsmart_certification/template/clientarea/js/authenticationCompny.js"></script>
