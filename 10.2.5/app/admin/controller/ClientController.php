...
{	
     ...
     * @return boolean client.certification 是否实名认证
     * @return object client.certification_detail 实名认证详情(当certification==true时,才会有此字段)
     * @return object client.certification_detail.company 企业实名认证详情
     * @return object client.certification_detail.person 个人实名认证详情
     */
