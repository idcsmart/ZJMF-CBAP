...
Route::group(DIR_ADMIN.'/v1',function (){
    ...
    Route::delete('order/recycle_bin', 'admin/order/deleteOrderFromRecycleBin'); # 从回收站删除订单
    Route::post('order/recycle_bin/clear', 'admin/order/clearRecycleBin'); # 清空回收站
    ...
    Route::delete('plugin/addon/:name', 'admin/plugin/addonUninstall'); # 插件卸载
    Route::put('plugin/addon/:name/:status', 'admin/plugin/addonStatus'); # 禁用(启用)插件
    ...
    Route::put('web_nav/:id/status', 'admin/WebNav/updateStatus');
    Route::put('web_nav/:id/drag', 'admin/WebNav/dragToSort');
