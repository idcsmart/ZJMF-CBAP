...
class EmailLogModel extends Model
{
     ...
     * @param   string param.message - 邮件内容
     * @param   int param.status - 发送状态(1=成功,0=失败)
     * @param   string param.to - 收件邮箱
     * @param   string param.fail_reason - 失败原因
     * @param   int param.rel_id - 关联ID
     * @param   string param.type - 关联类型(client=客户,admin=管理员)
     * @param   string param.ip 自动获取 IP
     * @param   int param.port 自动获取 端口号
     */
