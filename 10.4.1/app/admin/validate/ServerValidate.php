...
class ServerValidate extends Validate
{
    ...
    protected $message  =   [
        ...
        'url.max'                   => 'server_url_length_error',
        'username.max'              => 'server_username_cannot_exceed_100_chars',
        'password.max'              => 'server_password_cannot_exceed_100_chars',
        'hash.max'                  => 'server_hash_length_error',
        'status.in'     	        => 'server_status_only_zero_or_one',
    ];

    protected $scene = [
        'create' => ['name', 'module', 'url', 'username', 'password', 'hash', 'status'],
        'update' => ['id', 'name', 'module', 'url', 'username', 'password', 'hash', 'status'],
    ];
