<link rel="stylesheet" href="/{$template_catalog_cart}/template/{$themes}/css/settlement.css">
</head>
...
<body>
  ...
  <script src="/{$template_catalog_cart}/template/{$themes}/js/settlement.js"></script>