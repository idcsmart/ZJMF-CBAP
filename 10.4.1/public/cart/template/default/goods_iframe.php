...
<link rel="stylesheet" href="/{$template_catalog_cart}/template/{$themes}/css/goods_iframe.css">
</head>
...
<body>
  ...
  <script src="/{$template_catalog_cart}/template/{$themes}/js/goods.js"></script>
