  ...
  window.onload = function () {
    ...
    new Vue({
      ...
      methods: {
        ...
        handleClick () {
          this.fromData.require = this.fromData.require === 'range' ? '' : 'range'
        },
