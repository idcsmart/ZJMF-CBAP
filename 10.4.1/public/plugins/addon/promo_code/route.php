...
Route::group(DIR_ADMIN . '/v1',function (){
    ...
    # 启用/停用优惠码
    Route::put('promo_code/:id/status', "\\addon\\promo_code\\controller\\AdminIndexController@status")
        ->append(['_plugin'=>'promo_code','_controller'=>'admin_index','_action'=>'status']);
    # 删除优惠码
    Route::delete('promo_code/:id', "\\addon\\promo_code\\controller\\AdminIndexController@delete")
