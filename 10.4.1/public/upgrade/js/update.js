      ...
      data() {
        return {
          ...
          menu: [
            {
              id: 1,
              icon: `${url}/upgrade/img/iu/u-menu1.png`,
              text: "更新须知",
            },
            {
              id: 2,
              icon: `${url}/upgrade/img/iu/u-menu2.png`,
              text: "覆盖文件",
            },
            {
              id: 3,
              icon: `${url}/upgrade/img/iu/u-menu3.png`,
              text: "数据库更新",
            },
            {
              id: 4,
              icon: `${url}/upgrade/img/iu/u-menu4.png`,
              text: "执行文件",
            },
            {
              id: 5,
              icon: `${url}/upgrade/img/iu/u-menu5.png`,
              text: "升级完成",
            },
          ],
