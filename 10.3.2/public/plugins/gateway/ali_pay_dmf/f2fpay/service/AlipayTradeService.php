...
namespace gateway\ali_pay_dmf\f2fpay\service;
 ...
 * Time: 下午2:09
 */
use gateway\ali_pay_dmf\aop\request\AlipayTradePrecreateRequest;
use gateway\ali_pay_dmf\aop\AopClient;
use gateway\ali_pay_dmf\f2fpay\model\result\AlipayF2FPrecreateResult;
use gateway\ali_pay_dmf\f2fpay\model\result\AlipayF2FRefundResult;
use gateway\ali_pay_dmf\f2fpay\model\result\AlipayF2FQueryResult;
use gateway\ali_pay_dmf\f2fpay\model\result\AlipayF2FPayResult;
use gateway\ali_pay_dmf\f2fpay\model\builder\AlipayTradeQueryContentBuilder;
use gateway\ali_pay_dmf\f2fpay\model\builder\AlipayTradeCancelContentBuilder;
use think\Exception;
...
class AlipayTradeService {
    ...
    function check($arr){
        $aop = new AopClient();
        $aop->alipayrsaPublicKey = $this->alipay_public_key;
        $result = $aop->rsaCheckV1($arr, $this->alipay_public_key, $arr['sign_type']);
