...
function calculate(params) {
  return Axios.post(`/idcsmart_common/product/${params.id}/configoption/calculate`, params);
}
//产品配置升降级异步获取升降级价格
function syncUpgradePrice(id, params) {
  return Axios.post(`/idcsmart_common/host/${id}/sync_upgrade_config_price`, params);
}
// 产品升降级
