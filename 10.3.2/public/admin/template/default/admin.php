    ...
    <div class="common-header">
      ...
      <div class="right-search">
        ...
        <div class="com-search">
          <t-input v-model="params.keywords" class="search-input" :placeholder="`ID、${lang.nickname}、${lang.username}、${lang.email}`" @keyup.enter.native="seacrh" :on-clear="clearKey" clearable>
          </t-input>
        </div>
  ...
  <t-dialog :visible.sync="visible" :header="addTip" :on-close="close" :footer="false" width="600">
    <t-form :rules="rules" :data="formData" ref="userDialog" @submit="onSubmit">
      ...
      { validator: checkPwd, trigger: 'blur' }
        ...
        <t-input :placeholder="lang.surePassword" type="password" v-model="formData.repassword" />
      </t-form-item>
