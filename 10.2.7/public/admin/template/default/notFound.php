            ...
            <div v-for="(item,index) in navList" :key="index">
                ...
                <t-submenu :value="item.id" mode="popup" v-else>
                    ...
                    <!-- <template v-if="item.id===25">
                      ...
                      <li class="t-menu__item t-menu__item--plain t-submenu__item">
                        <a href="http://kfc.idcsmart.com/admin/plugin/idcsmart_ticket/ticket.htm">工单</a>
                      </li>
                      <li class="t-menu__item t-menu__item--plain t-submenu__item">
                        <a href="http://kfc.idcsmart.com/admin/plugin/idcsmart_promo_code/promo_code.htm">优惠码</a>
                      </li>
                      <li class="t-menu__item t-menu__item--plain t-submenu__item">
                        <a href="http://kfc.idcsmart.com/admin/plugin/idcsmart_refund/refund_product.htm">退款</a>
                      </li>
                      <li class="t-menu__item t-menu__item--plain t-submenu__item">
                        <a href="#">提现</a>
                      </li>
                      <li class="t-menu__item t-menu__item--plain t-submenu__item">
                        <a href="http://kfc.idcsmart.com/admin/plugin/idcsmart_help/help.htm">帮助中心</a>
                      </li>
                      <li class="t-menu__item t-menu__item--plain t-submenu__item">
                        <a href="http://kfc.idcsmart.com/admin/plugin/idcsmart_news/news.htm">新闻中心</a>
                      </li>
                      <li class="t-menu__item t-menu__item--plain t-submenu__item">
                        <a href="http://kfc.idcsmart.com/admin/plugin/idcsmart_file_download/file_download.htm">文件下载</a>
                      </li>
                    </template> -->
                </t-submenu>
            </div>
        ...
        <t-content class="area">
            ...
            <div id="content" class="template" v-cloak>
                <div class="content-box">
                    ...
                    <div class="tips-box">
                        页面找不到了
                        <p class="tran-again" @click="goBack">返回</p>
                    </div>
                </div>
            </div>
            <!-- =======页面独有======= -->
