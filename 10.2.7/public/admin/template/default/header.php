      ...
      <div class="header">
        ...
        <div class="h-left">
          ...
          <div class="global-search">
            <t-input :class="{ 'hover-active': isSearchFocus, 'h-search': true}" :placeholder="lang.please_search" @blur="changeSearchFocus(false)" @focus="changeSearchFocus(true)" @change="changeSearch" clearable>
