...
<div id="content" class="supplier_order order" v-cloak>
  <t-card class="list-card-container top-card">
    <ul class="common-tab">
      ...
      <li>
        <a :href="`supplier_goods.htm?id=${supplier_id}`">商品列表</a>
      </li>
      <li>
        <a :href="`supplier_product.htm?id=${supplier_id}`">产品列表</a>
      </li>
    </ul>
    <div class="money-box">
      <div class="item">
  ...
  <t-card class="list-card-container bottom-card b-table">
    <div class="common-header">
      ...
      <div class="client-search">
        <t-input v-model="params.keywords" placeholder="请输入搜索ID、用户名称、邮箱、手机号、商品名称" @keyup.enter.native="seacrh">
