      ...
      <div class="right-search">
        <template v-if="!isAdvance">
          ...
          <div class="com-search">
            ...
            :placeholder="`ID、${lang.username}、${lang.email}、${lang.phone}、${lang.product_name}`" @keyup.enter.native="seacrh" :on-clear="clearKey" clearable>
            </t-input>
        ...
        <template v-if="row.product_names">
          <div v-if="row.description">
            <t-tooltip theme="light" :show-arrow="false" placement="top-right">
              ...
              <a class="aHover" :href="row.host_id ? `host_detail.htm?client_id=${row.client_id}&id=${row.host_id}` : 'javascript:;'">{{row.product_names[0]}}</a>
