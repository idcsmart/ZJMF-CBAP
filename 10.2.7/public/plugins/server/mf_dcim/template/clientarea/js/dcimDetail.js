        ...
        getImage() {
            ...
            image(params).then(res => {
                if (res.data.status === 200) {
                    ...
                    this.osIcon = "/plugins/server/mf_dcim/view/img/" + this.osData[0].name + '.png'
        ...
        osSelectGroupChange(e) {
            this.osData.map(item => {
                if (item.id == e) {
                    ...
                    this.osIcon = "/plugins/server/mf_dcim/view/img/" + item.name + '.png'
