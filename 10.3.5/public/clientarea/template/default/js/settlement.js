        ...
        new Vue({
            ...
            methods: {
                ...
                goPay() {
                    ...
                    if (this.isFormShoppingCart) {
                        cart_settle({
                            positions: this.selectGoodsList, customfield: { voucher_get_id: this.cashObj.id }
                        }).then((res) => {
                ...
                getCommonData() {
                    ...
                    document.title = this.commonData.website_name + '-' + lang.shoppingCar_tip_text7
                },
            },
        }).$mount(template)
