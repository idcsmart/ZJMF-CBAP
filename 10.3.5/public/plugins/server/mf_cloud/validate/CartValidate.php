...
class CartValidate extends Validate
{
    ...
    protected $scene = [
        // 下单验证
        'cal'               => ['data_center_id','cpu','memory','image_id','system_disk','data_disk','backup_num','snap_num','duration_id','password','ssh_key_id','notes','network_type','bw','recommend_config_id'],
