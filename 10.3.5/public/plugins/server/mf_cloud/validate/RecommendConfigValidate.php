...
class RecommendConfigValidate extends Validate
{
    ...
    protected $scene = [
        'create'  => ['name','description','order','data_center_id','line_id','cpu','memory','system_disk_size','data_disk_size','bw','flow','peak_defence','ip_num','price'],
        'update'  => ['id','name','description','order','data_center_id','line_id','cpu','memory','system_disk_size','data_disk_size','bw','flow','peak_defence','ip_num','price'],
