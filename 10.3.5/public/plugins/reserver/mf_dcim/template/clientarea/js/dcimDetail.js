    ...
    getImage() {
      ...
      image(params).then(res => {
        if (res.data.status === 200) {
          ...
          this.osIcon = "/plugins/reserver/mf_dcim/template/clientarea/img/mf_dcim/" + this.osData[0].name + '.svg'
    ...
    osSelectGroupChange(e) {
      this.osData.map(item => {
        if (item.id == e) {
          ...
          this.osIcon = "/plugins/reserver/mf_dcim/template/clientarea/img/mf_dcim/" + item.name + '.svg'
