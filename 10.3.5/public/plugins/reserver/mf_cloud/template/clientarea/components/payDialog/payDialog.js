    ...
    template:
        ...
        <el-dialog width="6.8rem" custom-class='zf-dialog' :visible.sync="isShowZf" :show-close=false @close="zfClose">
            ...
            <div class="dialog-form">
                ...
                <el-row v-show = "!isNotPayWay">
                    <el-col :span="5"><span>&nbsp;</span></el-col>
                    <el-col :span="19">
                        <el-checkbox v-model="zfData.checked" @change="useBalance">优先使用余额</el-checkbox>
                    </el-col>
                </el-row>
                ...
                <el-row v-show="isShowPay">
                    <el-col :span="24">
                        <div class="pay-img-content" v-loading="payLoading">
                            ...
                            <el-button class="btn-no" @click="zfClose">关闭</el-button>
                        </div>
                    </el-col>
                </el-row>
                <el-row v-show="!isShowPay">
    ...
    methods: {
        ...
        zfSelectChange() {
            ...
            pay(params).then(res => {
                ...
                this.time = 300000
                this.payHtml = res.data.data.htm
            }).catch(error => {
