        ...
        new Vue({
            data() {
                const smallValidator = (val => {
                    ...
                    if (this.smallData && this.smallData.length > 0) {
                        this.smallData.forEach(item => {
                            if (item.isEdit) {
                                isPass = false
                                errText = lang.caravan_text43
                            }
                        })
                    } else {
                        isPass = false
                        errText = lang.caravan_text44
                    }
                ...
                return {
                    ...
                    rules: {
                        length: [
                            { required: true, message: lang.caravan_text47 },
                        ...
                        purchase: [
                            { required: true, message: lang.caravan_text48 },
                        ]
                    },
                    data: {},
                    purchase: "",
                    ...
                    columns: [
                        ...
                        {
                            colKey: "order",
                            title: lang.caravan_text49,
                        },
                        {
                            colKey: "cycle",
                            title: lang.caravan_text50,
                        },
                        {
                            colKey: "operation",
                            title: lang.caravan_text51,
                            width: 125
                        },
                    ],
                    promotion_time_min: "",
