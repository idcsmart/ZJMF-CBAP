      ...
      <el-container>
        ...
        <el-main>
          ...
          <div class="main-card">
            ...
            <img class="back-img" src="/plugins/addon/idcsmart_file_download/template/clientarea/img/source/source_back.png">
                ...
                <div class="box pc">
                  ...
                  <div class="com-l-box">
                    ...
                    <el-table :data="tableData" style="width: 100%" v-loading="loading">
                      ...
                      <el-table-column prop="opt" :label="lang.file_opt" width="130">
                        <template slot-scope="scope">
                          <span v-if="scope.row.isDownLoading"><i class="el-icon-loading"></i>文件下载中</span>
                          <span v-else="scope.row.isDownLoading"><i class="el-icon-download" @click="downFile(scope.row,scope.$index)"></i></span>
                        </template>
                      </el-table-column>
                    </el-table>
