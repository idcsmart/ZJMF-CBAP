  ...
  window.onload = function () {
    ...
    new Vue({
      data() {
        return {
          ...
          menu: [
            {
              id: 1,
              icon: `/install/img/iu/iu-welcome.svg`,
              text: "欢迎",
            },
            {
              id: 2,
              icon: `/install/img/iu/iu-common.svg`,
              text: "环境检查",
            },
            {
              id: 3,
              icon: `/install/img/iu/iu-db.svg`,
              text: "配置数据库",
            },
            {
              id: 4,
              icon: `/install/img/iu/iu-config.svg`,
              text: "配置信息",
            },
            {
              id: 5,
              icon: `/install/img/iu/iu-finish.svg`,
              text: "安装完成",
            },
          ],
          baseData: {
      ...
      created() {
        ...
        this.activeId = sessionStorage.getItem("installActiveId")
          ? sessionStorage.getItem("installActiveId")
          : 1;
        this.activeIdInit();
      },
      methods: {
        ...
        autoName() {
          ...
          this.configData.username =
            first.toLowerCase() + this.genEnCode(6, 1, 1, 0, 0, 1);
        },
        /**
         * 生成密码字符串
         * 33~47：!~/
