...
class IdcsmartCommon
{
    ...
    {
        return ['display_name'=>'通用产品', 'version'=>'2.0.1'];
    }
...
//        return $res;
    ...
    public function clientArea($params)
    {
        ...
        if (!empty($mobileTheme)){
            $res = [
                'template'=>use_mobile()?"template/clientarea/mobile/{$mobileTheme}/product_detail.html":'template/clientarea/pc/product_detail.html',
            ];
        }else{
    ...
    public function hostList($params){
        ...
        if (!empty($mobileTheme)){
            $res = [
                'template'=>use_mobile()?"template/clientarea/mobile/{$mobileTheme}/product_list.html":'template/clientarea/pc/product_list.html',
            ];
        }else{
            $clientareaTheme = configuration('clientarea_theme');
        ...
        if (!empty($mobileTheme)){
            $res = [
                'vars' => [
                    ...
                    'themes' => use_mobile()?$mobileTheme:configuration('clientarea_theme'),
                    'addons' => $addons['list']
                ],
                'template'=>use_mobile()?"template/clientarea/mobile/{$mobileTheme}/goods.html":'template/clientarea/pc/goods.html',
            ];
        }else{
