(function () {
  ...
  const module_lang = {
    "zh-cn": {
      ...
      mf_limit: "配置限制",
      mf_notes: "注意：",
      mf_p10: "用户增加带宽从配置的带宽起开始计费（推荐配置30M，用户升级到100M，收取70M费用）",
    ...
    "zh-hk": {
      ...
      mf_limit: "配置限制",
      mf_notes: "註意：",
      mf_p10: "用戶增加帶寬從配置的帶寬起開始計費（推薦配置30M，用戶升級到100M，收取70M費用）",
      ...
      mf_tip32: "可按 數量_分組id 分組輸入，示例：2_2,2_1。每組用逗號隔開，公網IP數量等於多組數量之和",
    ...
    "en-us": {
      ...
      mf_notes: "Note:",
      mf_p10: "When users increase bandwidth, they will be billed starting from the configured bandwidth (30M is recommended, and if the user upgrades to 100M, a 70M fee will be charged)",
      mf_p11: "The total memory and hard disk of the recommended configuration and optional configuration must not exceed the set maximum value",
      mf_p13: "Open as application",
      mf_p14: "Whether the optional machine is automatically activated",
      mf_p15: "If enabled, the machine that the user orders optional hardware will also be automatically enabled",
      mf_p16: "The price here does not include options. The price of optional content is calculated based on the hardware price in the value-added setting",
      mf_p17: "The total number of optional memory and hard disk cannot exceed the set maximum value",
      mf_p18: "Value-added options",
      mf_p19: "Allow value-added options",
      mf_p2: "Example: 64 cores 128 threads (2. 7GHz)",
      mf_p20: "After turning it on, users can make value-added options at the front desk",
      ...
      mf_p27: "When enabling value-added options, you need to first go to 'Value-Added Settings' to set the corresponding option parameters",
      mf_p28: "The number of graphics cards can be increased",
      mf_p29: "Can be added graphics number",
      mf_p30: "After turning it on, users can only select value-added items at upgrade and downgrade levels",
      ...
      mf_p6: "Please add the model specifications that allow customers to change the configuration here",
      ...
      mf_p9: "The price of optional content is calculated according to the price of the hardware in the value-added setting",
      ...
      mf_tip32: "You can enter groups according to quantity_group id, example: 2_2, 2_1. Each group is separated by commas, and the number of public network IPs is equal to the sum of the numbers of multiple groups",
