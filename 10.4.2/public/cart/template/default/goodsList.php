<!-- 页面独有样式 -->
<link rel="stylesheet" href="/{$template_catalog_cart}/template/{$themes}/css/goodsList.css">
</head>
...
<body>
                ...
                <template v-if="!isDomain">
                  ...
                  <div v-else class="goods-list-div">
                    <div v-for="item in goodsList" :key="item.id" class="shopping-item">
                      ...
                      <div class="btn-box">
                        <span class="item-price">{{commonData.currency_prefix}} {{item.price}}{{item.cycle ? '/' +
                          item.cycle : ''}}</span>
                                ...
                                <div class="domain-item" v-for="(item,index) in calcDomainList(domainList)"
                                  ...
                                  <div class="item-right">
                                    ...
                                    <el-popover placement="bottom" trigger="hover">
                                      <div class="pirce-box" v-if="item.avail === 1" slot="reference"
                                        v-loading="item.priceLoading">
  ...
  <!-- =======页面独有======= -->
  <script src="/{$template_catalog_cart}/template/{$themes}/api/goodsList.js"></script>
  <script src="/{$template_catalog_cart}/template/{$themes}/js/goodsList.js"></script>
  <script src="/{$template_catalog_cart}/template/{$themes}/api/product.js"></script>
