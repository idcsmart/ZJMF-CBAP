<!-- 页面独有样式 -->
<link rel="stylesheet" href="/{$template_catalog_cart}/template/{$themes}/css/shoppingCar.css">
</head>
...
<body>
                      ...
                      <table class="goods-table">
                        ...
                        <tbody>
                          <tr v-if="item.info">
                            ...
                            <td class="delete-btn">
                              <i class="el-icon-delete" @click="handelDeleteGoods(item,index)"></i>
                            </td>
                          </tr>
                          <tr v-else>
                            <td></td>
  ...
  <!-- =======页面独有======= -->
  <script src="/{$template_catalog_cart}/template/{$themes}/api/shopping.js"></script>
  ...
  <script src="/{$template_catalog_cart}/template/{$themes}/js/shoppingCar.js"></script>