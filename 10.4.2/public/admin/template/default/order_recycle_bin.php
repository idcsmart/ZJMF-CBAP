...
<div id="content" class="order order-recyle" v-cloak>
  <com-config>
    <t-card class="list-card-container">
      <div class="common-header recyle-top">
        ...
        <div class="right-search">
          ...
          <t-button class="add" @click="handleRecyle('clear')" :disabled="data.length === 0"
          v-permission="'auth_business_order_recycle_bin_clear'">{{lang.clear_recycle_bin}}</t-button>
        </div>
      </div>
      <div class="common-header">
        ...
        <div class="right-search">
          <template v-if="!isAdvance">
            <t-date-range-picker allow-input clearable v-model="delRange" style="margin-right: 20px;" :placeholder="[`${lang.order_del_time}`,`${lang.order_del_time}`]">
            </t-date-range-picker>
    ...
    <!-- 回收设置 -->
    <t-dialog :header="lang.recycle_setting" :visible.sync="settingVisble" :footer="false">
