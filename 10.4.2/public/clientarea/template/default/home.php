              ...
              <div class="left-box">
                <div class="info-box">
                  ...
                  <div class="info-three" v-plugin="'IdcsmartCertification'"
                    ...
                    <div class="email-box" v-show="certificationObj.certification_company_open === 1">
                      <span><img src="/{$template_catalog}/template/{$themes}/img/home/compny-icon.png"
                          alt="">{{lang.index_compny}}</span>
                    ...
                    <div class="phone-box">
                      <span><img src="/{$template_catalog}/template/{$themes}/img/home/person-icon.png"
                          alt="">{{lang.index_name}}</span>
                      ...
                      <div class="statistics-top">
                        <div class="statisticstop-left">
                          <div class="credit-box">
                            <div class="statistics-credit">{{commonData.currency_prefix}}{{account.credit}}</div>
