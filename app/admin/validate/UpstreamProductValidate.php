...
class UpstreamProductValidate extends Validate
{
    ...
    protected $scene = [
        'create' => ['supplier_id', 'upstream_product_id', 'name', 'profit_percent', 'auto_setup', 'certification', 'product_group_id'],
        'update' => ['id', 'supplier_id', 'upstream_product_id', 'name', 'profit_percent', 'auto_setup', 'certification', 'product_group_id'],
