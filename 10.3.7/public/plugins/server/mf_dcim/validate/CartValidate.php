...
class CartValidate extends Validate
{
    ...
    protected $message  =   [
        ...
        'model_config_id.requireWithout'=> 'please_select_model_config',
        ...
        'ip_num.requireWithout'         => 'mf_dcim_please_select_ip_num',
    ...
    protected $scene = [
        // 下单验证
        'cal'       => ['data_center_id','line_id','model_config_id','package_id','image_id','duration_id','notes','ip_num','optional_memory','optional_disk'],
