                ...
                <el-tab-pane :label="lang.subaccount_text56" name="3" v-if="havePlugin('ClientCare')">
                  ...
                  <div class="content_table">
                    <div class="tabledata">
                        ...
                        <el-table-column :label="lang.subaccount_text58">
                          <template slot-scope="scope">
                            <span @click="goMsgDetail(scope.row.id)">
                              <span class="msg-status" :class="scope.row.read === 1 ? 'is-read' : 'no-read'">【{{scope.row.read === 1 ? lang.subaccount_text66 : lang.subaccount_text67}}】</span>
                      ...
                      <pagination :page-data="msgParams" @sizechange="msgSizeChange" @currentchange="msgCurrentChange"></pagination>
                    </div>
                  </div>
                </el-tab-pane>
              </el-tabs>
