const lang_obj = {
  ...
  start_id_tip: "After the change, if the start ID is less than the existing data, continue to add from the existing data, if it is greater, start recording from the new start ID.",
  ...
  order_text88: "Modify renewal amount",
  order_text89: "Modify the default renewal amount for the product",
  ...
  recommend_tip8: "Please enter the default page for the user referral link to jump to, otherwise it will default to the system official website",
  recommend_tip9:
    "If the redirected website is another site, the 'recommend_c' parameter in the referral link needs to be saved in the cookie of the redirected site to avoid referral failure.",
  ...
  da_tip2: 'If the user buys one year fee amount = domain name amount minus gift amount',
  da_tip3: 'If purchased for many years, charge amount = domain name amount minus domain name purchase amount for one year',
  da_tip4: 'Can be set at the gift domain name, gift domain name price limit',
  da_tip5: 'Select the domain name automatically assigned when the user is opened',
