      ...
      methods: {
        ...
        async getSetting() {
          try {
            ...
            this.formData.system_logo = []
            this.formData.client_start_id_value = Number(res.data.data.client_start_id_value)
            this.formData.order_start_id_value = Number(res.data.data.order_start_id_value)
